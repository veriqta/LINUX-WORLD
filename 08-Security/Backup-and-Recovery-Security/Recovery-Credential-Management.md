...
This guide explains recovery credential management as part of Linux defensive security. It connects the security objective to safe administration, verification, monitoring and recovery.
...
- Explain how recovery credential management supports confidential, tamper-resistant and recoverable backups.
...
In an isolated VM, document the current recovery credential management state, identify one defensible improvement, predict its operational effect, implement it through a safe change, verify positive and negative cases, then restore the original state. Submit the threat model, commands, evidence, rollback result and remaining risk.

## Review questions

1. Which threat does recovery credential management reduce, and which threats remain?
