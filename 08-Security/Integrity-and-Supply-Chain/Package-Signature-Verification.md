...
This guide explains package signature verification as part of Linux defensive security. It connects the security objective to safe administration, verification, monitoring and recovery.
...
- Explain how package signature verification supports software provenance and unauthorized-change detection.
...
- Define the exact asset, trust boundary and failure consequence for package signature verification.
...
In an isolated VM, document the current package signature verification state, identify one defensible improvement, predict its operational effect, implement it through a safe change, verify positive and negative cases, then restore the original state. Submit the threat model, commands, evidence, rollback result and remaining risk.

## Review questions

1. Which threat does package signature verification reduce, and which threats remain?
