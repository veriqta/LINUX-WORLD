...
This guide explains unauthorized change investigation as part of Linux defensive security. It connects the security objective to safe administration, verification, monitoring and recovery.
...
- Explain how unauthorized change investigation supports software provenance and unauthorized-change detection.
...
- Define the exact asset, trust boundary and failure consequence for unauthorized change investigation.
...
In an isolated VM, document the current unauthorized change investigation state, identify one defensible improvement, predict its operational effect, implement it through a safe change, verify positive and negative cases, then restore the original state. Submit the threat model, commands, evidence, rollback result and remaining risk.

## Review questions

1. Which threat does unauthorized change investigation reduce, and which threats remain?
