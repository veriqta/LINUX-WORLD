# Parent Child and Orphan Processes

This article explains parent child and orphan processes as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how parent child and orphan processes helps Linux represent execution and decide when and where runnable tasks use CPUs.
...
- Parent Child and Orphan Processes is not fully explained by one command or one counter.
...
1. What problem does parent child and orphan processes solve?
