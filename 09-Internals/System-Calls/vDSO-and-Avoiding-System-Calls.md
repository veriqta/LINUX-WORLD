# vDSO and Avoiding System Calls

This article explains vdso and avoiding system calls as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how vdso and avoiding system calls helps Linux provide controlled entry points from userspace into kernel services.
...
- vDSO and Avoiding System Calls is not fully explained by one command or one counter.
...
1. What problem does vdso and avoiding system calls solve?
