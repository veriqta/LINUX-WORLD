# Monolithic Kernel and Loadable Modules

This article explains monolithic kernel and loadable modules as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how monolithic kernel and loadable modules helps Linux mediate hardware and provide protected process, memory, filesystem, network and device services.
...
- Monolithic Kernel and Loadable Modules is not fully explained by one command or one counter.
...
1. What problem does monolithic kernel and loadable modules solve?
