# Traffic Control and Queueing

This article explains traffic control and queueing as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how traffic control and queueing helps Linux move application data through sockets, protocols, policy, routing, queues and network devices.
...
- Traffic Control and Queueing is not fully explained by one command or one counter.
...
1. What problem does traffic control and queueing solve?
