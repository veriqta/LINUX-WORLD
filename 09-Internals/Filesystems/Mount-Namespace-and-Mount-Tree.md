# Mount Namespace and Mount Tree

This article explains mount namespace and mount tree as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how mount namespace and mount tree helps Linux present persistent and pseudo data through a uniform pathname and file API.
...
- Mount Namespace and Mount Tree is not fully explained by one command or one counter.
...
1. What problem does mount namespace and mount tree solve?
