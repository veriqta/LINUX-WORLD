# procfs sysfs and tmpfs

This article explains procfs sysfs and tmpfs as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how procfs sysfs and tmpfs helps Linux present persistent and pseudo data through a uniform pathname and file API.
...
- procfs sysfs and tmpfs is not fully explained by one command or one counter.
...
1. What problem does procfs sysfs and tmpfs solve?
