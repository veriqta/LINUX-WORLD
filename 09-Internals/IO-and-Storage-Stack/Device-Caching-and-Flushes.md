# Device Caching and Flushes

This article explains device caching and flushes as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how device caching and flushes helps Linux move data between applications, caches, block layers, mappings, drivers and durable media.
...
- Device Caching and Flushes is not fully explained by one command or one counter.
...
1. What problem does device caching and flushes solve?
