# Read Write and Memory Mapped IO

This article explains read write and memory mapped io as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how read write and memory mapped io helps Linux move data between applications, caches, block layers, mappings, drivers and durable media.
...
- Read Write and Memory Mapped IO is not fully explained by one command or one counter.
...
1. What problem does read write and memory mapped io solve?
