# IO Requests and Queues

This article explains io requests and queues as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how io requests and queues helps Linux move data between applications, caches, block layers, mappings, drivers and durable media.
...
- IO Requests and Queues is not fully explained by one command or one counter.
...
1. What problem does io requests and queues solve?
