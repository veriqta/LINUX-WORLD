# PCI and USB Discovery

This article explains pci and usb discovery as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how pci and usb discovery helps Linux connect physical and virtual hardware to kernel drivers and userspace interfaces.
...
- PCI and USB Discovery is not fully explained by one command or one counter.
...
1. What problem does pci and usb discovery solve?
