# Emergency and Rescue Boot

This article explains emergency and rescue boot as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how emergency and rescue boot helps Linux transfer control from firmware to a fully initialized userspace.
...
- Emergency and Rescue Boot is not fully explained by one command or one counter.
...
1. What problem does emergency and rescue boot solve?
