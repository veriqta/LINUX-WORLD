# PID 1 and Userspace Initialization

This article explains pid 1 and userspace initialization as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how pid 1 and userspace initialization helps Linux transfer control from firmware to a fully initialized userspace.
...
- PID 1 and Userspace Initialization is not fully explained by one command or one counter.
...
1. What problem does pid 1 and userspace initialization solve?
