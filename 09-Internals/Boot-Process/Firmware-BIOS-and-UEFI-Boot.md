# Firmware BIOS and UEFI Boot

This article explains firmware bios and uefi boot as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how firmware bios and uefi boot helps Linux transfer control from firmware to a fully initialized userspace.
...
- Firmware BIOS and UEFI Boot is not fully explained by one command or one counter.
...
1. What problem does firmware bios and uefi boot solve?
