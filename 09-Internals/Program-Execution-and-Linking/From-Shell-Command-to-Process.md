# From Shell Command to Process

This article explains from shell command to process as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how from shell command to process helps Linux turn an executable request into a mapped, initialized process.
...
- From Shell Command to Process is not fully explained by one command or one counter.
...
1. What problem does from shell command to process solve?
