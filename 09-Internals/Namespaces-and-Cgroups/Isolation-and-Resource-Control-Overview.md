# Isolation and Resource Control Overview

This article explains isolation and resource control overview as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how isolation and resource control overview helps Linux isolate views of global resources and account for or control resource consumption.
...
- Isolation and Resource Control Overview is not fully explained by one command or one counter.
...
1. What problem does isolation and resource control overview solve?
