# Tracing Overhead and Safety

This article explains tracing overhead and safety as part of Linux internals. It focuses on why the mechanism exists, which kernel and userspace components participate, how state changes, and how an administrator can observe it safely.
...
- Explain how tracing overhead and safety helps Linux turn transient subsystem behavior into evidence with acceptable overhead.
...
- State collection overhead, privilege and kernel compatibility before tracing.
- Use filters, bounded duration and bounded buffers.
- Absence of an event may mean the probe, filter or observation point was wrong.
...
- Tracing Overhead and Safety is not fully explained by one command or one counter.
...
1. What problem does tracing overhead and safety solve?
