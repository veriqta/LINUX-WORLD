# Package Management: Practical Workflows
...
1. Identify distribution: `cat /etc/os-release`.
2. Refresh metadata using the native package manager.
3. Inspect candidate, repository, architecture, and dependencies.
4. Take configuration and state backups where rollback matters.
5. Install or upgrade within a change window.
6. Review transaction output and configuration-file prompts.
7. Verify package version, service health, ports, logs, and application tests.
