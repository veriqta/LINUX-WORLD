# Log Rotation Breaks Application Logging

## Scenario

Logs stop, continue in a deleted file, or grow unexpectedly after rotation.
...
Use the application's supported reopen method or a justified rotation strategy.
...
After forced test rotation, the process writes to the new file and retention works.
