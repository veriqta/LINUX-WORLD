...
A listening service is reachable locally but not from an intended remote source.
...
Add the least-permissive rule for the approved source and service. Preserve administrative access.
...
Authorized paths work, unauthorized paths remain blocked, and counters show the expected rule.
