...
A unit fails because an ordering, requirement, mount, network, or environment dependency is unavailable.
...
Correct dependency semantics or readiness. Do not add arbitrary sleeps when an explicit readiness condition exists.
...
Cold boot and controlled dependency failure behave as designed.
