# Container Host Resource Pressure

## Scenario

A Linux host running containers suffers memory, CPU, PID, disk, or file-descriptor pressure.
...
- Host versus cgroup limits
- Image and layer growth
- Logs
- Inode usage
- PID limits
- CPU throttling
...
Protect critical workloads, stop runaway consumers, and enforce tested resource and log limits.
...
Host pressure clears and workloads operate within explicit limits during load.
