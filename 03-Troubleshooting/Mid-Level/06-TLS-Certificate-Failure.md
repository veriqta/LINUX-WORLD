...
Clients report expiry, hostname mismatch, unknown issuer, incomplete chain, or handshake failure.
...
Install the correct chain and reload the correct process after validation. Protect private keys.
...
All intended client types validate the chain and hostname, and expiry monitoring is active.
