...
Latency and errors trigger retries that multiply load across services and Linux hosts.
...
Rate-limit or disable harmful retries, shed noncritical load, and protect the constrained dependency.
...
Request rate, retries, queues, saturation, and tail latency remain stable during recovery.
