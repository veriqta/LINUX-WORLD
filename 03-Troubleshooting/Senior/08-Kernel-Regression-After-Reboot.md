# Kernel Regression After Reboot

## Scenario

A reboot activates a new kernel and introduces hardware, network, filesystem, or performance failure.
...
Boot a known-good kernel through approved recovery, then pin temporarily while root cause is investigated.
...
Known-good operation is restored, reboot behavior is controlled, and regression evidence is preserved.
