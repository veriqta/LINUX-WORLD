...
Workers wait for database or upstream connections while the process remains alive.
...
Reduce leaks or long holders, align limits, and cap concurrency. Increasing the pool alone may move failure downstream.
...
Pool wait approaches baseline, no leak trend remains, and downstream headroom is preserved.
