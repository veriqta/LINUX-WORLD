...
Tail latency and retransmissions rise under load despite apparent link availability.
...
Remove the bottleneck or correct queue, MTU, offload, routing, or workload behavior based on evidence.
...
Drops and retransmissions normalize at representative throughput without hiding congestion.
