# Failed Configuration Rollout Across a Fleet

## Scenario

A valid-looking configuration causes partial or widespread failure across Linux systems.
...
native validators
healthy versus unhealthy diff
fleet health and logs
```
...
Halt rollout, isolate affected cohorts, and restore the last verified configuration through the same controlled mechanism.
...
Fleet health, configuration convergence, rollback completeness, and monitoring are verified.
