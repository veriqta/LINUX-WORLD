...
Expected messages are absent from the journal or log files.
...
Correct logging destination, permissions, persistence, or rotation. Avoid increasing verbosity indefinitely.
...
A controlled test event appears with the correct timestamp and retention behavior.
