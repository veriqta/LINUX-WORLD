...
Writes fail with `No space left on device`, or a filesystem reaches its threshold.
...
Free a small, known-safe amount, stop runaway growth, and correct retention. Do not delete unknown data.
...
Blocks and inodes have headroom, writes succeed, growth is controlled, and alerts are active.
