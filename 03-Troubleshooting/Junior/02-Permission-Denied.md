...
A user or service cannot read, write, execute, or traverse a path.
...
Grant only the required access to the correct identity. Prefer group or ACL design over broad modes such as 777.
...
Test as the affected identity and confirm unrelated users did not gain access.
