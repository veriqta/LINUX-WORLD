...
SSH times out, rejects credentials, closes immediately, or denies authorization.
...
Use console access if needed, validate configuration before reload, and correct the narrow cause.
...
A new session authenticates with the intended method while prohibited access remains blocked.
