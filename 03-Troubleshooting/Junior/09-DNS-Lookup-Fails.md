...
Hostnames fail while direct IP connectivity may still work.
...
Restore a valid resolver path or correct the record. Do not hardcode temporary IP addresses without ownership and expiry.
...
System and application resolvers return the intended records within expected time.
