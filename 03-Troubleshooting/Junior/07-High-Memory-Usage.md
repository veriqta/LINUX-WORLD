...
The host reports low free memory, swap activity, or an out-of-memory kill.
...
Reduce the failing workload or restore capacity. Do not clear caches as a routine fix.
...
Memory pressure and swap activity normalize, no new OOM events occur, and service health recovers.
