...
This guide explains firewalld as it applies specifically to Fedora. It records distribution differences without repeating the general Linux course.
...
firewalld is commonly installed. Inventory the current rules, default policy, zones or chains, IPv4 and IPv6 behavior, persistence, and management-access path before a change.
