...
This guide explains package management with dnf and rpm as it applies specifically to Fedora. It records distribution differences without repeating the general Linux course.
...
Fedora uses DNF and RPM. The high-level package manager resolves dependencies and repositories; the lower-level package database records installed files and metadata.
