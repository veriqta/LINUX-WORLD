# Storage LVM Btrfs and Filesystems
...
This guide explains storage lvm btrfs and filesystems as it applies specifically to Fedora. It records distribution differences without repeating the general Linux course.
...
Btrfs is common on Workstation while Server and custom installations may differ. Map the complete path from block device to partition, encryption, RAID, volume manager, filesystem, mount, and consuming service.
