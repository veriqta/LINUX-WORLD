...
This guide explains rocky linux server hardening as it applies specifically to Rocky-Linux. It records distribution differences without repeating the general Linux course.
