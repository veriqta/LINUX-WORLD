# Releases Lifecycle and Compatibility
...
This guide explains releases lifecycle and compatibility as it applies specifically to Rocky-Linux. It records distribution differences without repeating the general Linux course.
...
The supported administrative path is minor releases use DNF; major-version in-place upgrade support must be verified and may require reinstall or migration. Read the source and target release notes, confirm lifecycle status from the official source, update the current release fully, test backups, inventory third-party repositories, validate free space, and rehearse rollback or rebuild.
