...
This guide explains firewalld as it applies specifically to Rocky-Linux. It records distribution differences without repeating the general Linux course.
...
firewalld is the common host-firewall frontend. Inventory the current rules, default policy, zones or chains, IPv4 and IPv6 behavior, persistence, and management-access path before a change.
