# AppArmor and Security Controls
...
This guide explains apparmor and security controls as it applies specifically to Debian. It records distribution differences without repeating the general Linux course.
