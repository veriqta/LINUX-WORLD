...
This guide explains package management with apt and dpkg as it applies specifically to Debian. It records distribution differences without repeating the general Linux course.
...
Debian uses APT and dpkg. The high-level package manager resolves dependencies and repositories; the lower-level package database records installed files and metadata.
