...
This guide explains logging and journald as it applies specifically to Debian. It records distribution differences without repeating the general Linux course.
...
Verify persistent journal configuration, forwarding, rotation, rate limiting, time synchronization, and application-specific logs.
...
A missing event may reflect retention, filtering, rate limits, permissions, clock error, or collection failure. Preserve original timestamps and redact sensitive fields before sharing evidence.
