...
This guide explains networking and netplan as it applies specifically to Ubuntu. It records distribution differences without repeating the general Linux course.
...
Netplan commonly renders configuration for systemd-networkd or NetworkManager. systemd-resolved is common; verify rather than assume. Inspect the active manager, generated runtime state, routes, addresses, and resolver before editing configuration.
