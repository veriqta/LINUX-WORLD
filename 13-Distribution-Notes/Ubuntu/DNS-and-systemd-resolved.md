...
This guide explains dns and systemd resolved as it applies specifically to Ubuntu. It records distribution differences without repeating the general Linux course.
