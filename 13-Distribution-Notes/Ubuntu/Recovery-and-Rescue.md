...
This guide explains recovery and rescue as it applies specifically to Ubuntu. It records distribution differences without repeating the general Linux course.
