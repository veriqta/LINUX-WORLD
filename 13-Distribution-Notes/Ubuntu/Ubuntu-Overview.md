...
This guide explains ubuntu overview as it applies specifically to Ubuntu. It records distribution differences without repeating the general Linux course.
