...
This guide explains package management with apt as it applies specifically to Ubuntu. It records distribution differences without repeating the general Linux course.
