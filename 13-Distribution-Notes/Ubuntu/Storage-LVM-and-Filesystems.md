...
This guide explains storage lvm and filesystems as it applies specifically to Ubuntu. It records distribution differences without repeating the general Linux course.
...
ext4 and LVM are common server choices; verify the installed layout. Map the complete path from block device to partition, encryption, RAID, volume manager, filesystem, mount, and consuming service.
