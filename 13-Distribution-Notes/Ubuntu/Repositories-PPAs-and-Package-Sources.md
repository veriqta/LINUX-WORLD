# Repositories PPAs and Package Sources
...
This guide explains repositories ppas and package sources as it applies specifically to Ubuntu. It records distribution differences without repeating the general Linux course.
...
Ubuntu uses APT and dpkg. The high-level package manager resolves dependencies and repositories; the lower-level package database records installed files and metadata.
