...
This guide explains ubuntu command reference as it applies specifically to Ubuntu. It records distribution differences without repeating the general Linux course.
