...
This guide explains ufw and firewall management as it applies specifically to Ubuntu. It records distribution differences without repeating the general Linux course.
...
UFW is a common frontend; nftables is the kernel-facing framework. Inventory the current rules, default policy, zones or chains, IPv4 and IPv6 behavior, persistence, and management-access path before a change.
