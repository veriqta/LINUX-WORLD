...
Inspects PEM certificate files and reports expiry metadata.
...
```bash
./python3 -m certificate_inventory --help
```
...
- Tool: `python3 -m certificate_inventory`
- Tests: `tests/`
- Examples: `examples/`
...
- [Python Scripts overview](../README.md)
