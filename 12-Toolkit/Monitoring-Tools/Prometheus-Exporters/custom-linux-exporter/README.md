# custom linux exporter

This resource defines the Linux World prometheus exporters standard for custom linux exporter. It is written for students, system administrators, reviewers, and contributors who need predictable and safe operational tooling.
