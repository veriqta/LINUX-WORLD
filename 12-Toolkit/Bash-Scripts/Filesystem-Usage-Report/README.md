...
Reports mounted filesystem capacity and inode consumption.
...
```bash
./filesystem-usage-report.sh --help
```
...
- Tool: `filesystem-usage-report.sh`
- Tests: `tests/`
- Examples: `examples/`
...
- [Bash Scripts overview](../README.md)
