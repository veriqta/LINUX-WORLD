# Disk Capacity Guardian: Troubleshooting
...
The project explicitly tests absent mount, inode pressure, deleted-open files, permission errors, and overlapping runs.
