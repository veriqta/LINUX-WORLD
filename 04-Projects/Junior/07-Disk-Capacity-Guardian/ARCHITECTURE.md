# Disk Capacity Guardian: Architecture

## Goal

Monitor block and inode use, identify large paths safely, emit status codes, and produce operator guidance.
...
The implementation must handle absent mount, inode pressure, deleted-open files, permission errors, and overlapping runs.
