# Disk Capacity Guardian: Acceptance Tests
...
Test each condition: Inode exhaustion, deleted-open files, absent mounts, permission errors, rapidly growing logs, and overlapping runs.
