# Systemd-Managed Web Service: Implementation Guide
...
Exercise these conditions: Port conflict, missing environment, crash loop, wrong working directory, permission denial, failed health check, and reboot persistence.
