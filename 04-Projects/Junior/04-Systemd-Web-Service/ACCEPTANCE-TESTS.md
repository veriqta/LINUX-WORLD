# Systemd-Managed Web Service: Acceptance Tests
...
Test each condition: Port conflict, missing environment, crash loop, wrong working directory, permission denial, failed health check, and reboot persistence.
