# Hardened SSH Server: Architecture

## Goal

Apply a validated OpenSSH drop-in with key-based access, controlled groups, logs, firewall planning, and console recovery.
...
The implementation must handle invalid configuration, key permissions, firewall lockout, wrong AllowGroups, and unavailable console.
