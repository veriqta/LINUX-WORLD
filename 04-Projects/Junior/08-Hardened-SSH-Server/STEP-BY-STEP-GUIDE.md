# Hardened SSH Server: Step-by-Step Guide
...
Create a lab administrator, install a test key, validate sshd, apply the drop-in, test a second session, and recover safely.
