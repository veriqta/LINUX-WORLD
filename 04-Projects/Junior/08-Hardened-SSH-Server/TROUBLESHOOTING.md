# Hardened SSH Server: Troubleshooting
...
The project explicitly tests invalid configuration, key permissions, firewall lockout, wrong AllowGroups, and unavailable console.
