# Users, Groups, and Access Management: Acceptance Tests
...
Test each condition: Duplicate IDs, stale groups, locked accounts, expired passwords, invalid shells, unsafe sudo rules, and sessions surviving offboarding.
