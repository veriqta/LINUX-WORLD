# Users, Groups, and Access Management: Implementation Guide
...
Exercise these conditions: Duplicate IDs, stale groups, locked accounts, expired passwords, invalid shells, unsafe sudo rules, and sessions surviving offboarding.
