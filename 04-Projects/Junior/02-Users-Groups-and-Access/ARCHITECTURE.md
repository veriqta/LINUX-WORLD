# Users, Groups, and Access Management: Architecture

## Goal

Create controlled lab users, groups, shared access, delegated sudo, and an offboarding workflow.
...
The implementation must handle duplicate identities, unsafe sudo policy, stale sessions, and incorrect ownership.
