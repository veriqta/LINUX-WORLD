# Log Analysis Toolkit: Architecture

## Goal

Build a safe log-analysis command that summarizes levels, sources, status codes, and recurring messages.
...
The implementation must handle compressed logs, malformed lines, huge files, missing fields, and sensitive data.
