# System Baseline Audit: Acceptance Tests
...
Test each condition: Missing tools, permission-denied fields, virtual versus physical hosts, containers, large output, and inconsistent command availability.
