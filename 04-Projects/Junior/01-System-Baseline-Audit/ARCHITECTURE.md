# System Baseline Audit: Architecture

## Goal

Collect a read-only Linux baseline and produce a timestamped report.
...
The implementation must handle missing optional commands, permission-denied fields, sensitive output, and partial collection.
