# System Baseline Audit: Prerequisites
...
bash, coreutils, procps, iproute2, util-linux, systemd where available

## Privilege

sudo access is optional; most collection works unprivileged
