# System Baseline Audit: Troubleshooting
...
The project explicitly tests missing optional commands, permission-denied fields, sensitive output, and partial collection.
