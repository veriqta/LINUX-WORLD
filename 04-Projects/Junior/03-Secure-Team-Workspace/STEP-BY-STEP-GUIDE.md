# Secure Team Workspace: Step-by-Step Guide

## Outcome

Create a shared workspace using group ownership, setgid inheritance, default ACLs, and private subdirectories.
...
Build the workspace, create files as different users, verify inheritance, test denials, and remove the lab safely.
