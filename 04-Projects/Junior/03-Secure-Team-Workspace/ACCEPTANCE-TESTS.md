# Secure Team Workspace: Acceptance Tests
...
Test each condition: New files with wrong group, ACL mask surprises, renamed files, copied content, service accounts, and offboarded members.
