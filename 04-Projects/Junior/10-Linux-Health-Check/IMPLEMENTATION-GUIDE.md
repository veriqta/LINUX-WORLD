# Linux Health Check: Implementation Guide
...
Exercise these conditions: Missing commands, non-systemd host, container limits, unavailable service, timeout, locale differences, and partial data.
