# Automated Backup and Restore: Acceptance Tests
...
Test each condition: Partial backup, full destination, interrupted run, changed permissions, deleted source, corrupt archive, and restore to alternate location.
