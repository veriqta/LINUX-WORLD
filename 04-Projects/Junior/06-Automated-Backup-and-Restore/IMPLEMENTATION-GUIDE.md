# Automated Backup and Restore: Implementation Guide
...
Exercise these conditions: Partial backup, full destination, interrupted run, changed permissions, deleted source, corrupt archive, and restore to alternate location.
