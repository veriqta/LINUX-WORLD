# Package Inventory and Controlled Updates: Implementation Guide
...
Exercise these conditions: Repository failure, lock contention, dependency conflict, disk shortage, service restart, and configuration-file prompt.
