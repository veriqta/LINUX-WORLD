# Multi-Site Operations Simulation: Architecture

## Mission

Operate a Linux service across two simulated sites with traffic control, state strategy, site-failure procedures, observability, capacity planning, failover, and failback.
