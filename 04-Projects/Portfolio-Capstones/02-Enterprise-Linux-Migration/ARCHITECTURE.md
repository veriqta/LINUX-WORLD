# Enterprise Linux Migration: Architecture

## Mission

Discover, design, rehearse, cut over, validate, and roll back a migration from a legacy Linux service to a supported target distribution.
