# Enterprise Linux Migration: Implementation Guide
...
Exercise: Unsupported package, configuration incompatibility, UID mismatch, data drift, DNS delay, performance regression, and failed rollback.
