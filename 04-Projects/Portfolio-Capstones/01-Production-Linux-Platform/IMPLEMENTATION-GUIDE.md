# Production Linux Platform: Implementation Guide
...
Exercise: Host loss, bad deployment, full filesystem, certificate failure, dependency outage, credential rotation, and restore to replacement infrastructure.
