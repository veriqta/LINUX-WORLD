# Production Linux Platform: Architecture

## Mission

Provision and operate a small production-style Linux platform with identity, network boundaries, service deployment, storage, observability, backup, patching, failure response, and rebuild.
