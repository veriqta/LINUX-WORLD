# Linux Fleet Operations System: Implementation Guide
...
Exercise: Control-plane outage, partial rollout, compromised host, stale inventory, package regression, expiring credential, and decommission failure.
