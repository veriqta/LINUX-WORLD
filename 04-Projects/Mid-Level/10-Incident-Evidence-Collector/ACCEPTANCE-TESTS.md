# Incident Evidence Collector: Acceptance Tests
...
Exercise: Hung command, huge log, missing tool, permission denial, secret detection, partial collection, and low disk space.
