# Incident Evidence Collector: Commands Explained

The implementation uses commands appropriate to collection modules, timeouts, redaction, archive integrity, least privilege, evidence handling. For each command, document purpose, options, privilege, input, output, exit status, persistent change, rollback, and portability.
