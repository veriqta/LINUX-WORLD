# Incident Evidence Collector: Portfolio Notes
...
Be ready to explain how the system behaves during Hung command, huge log, missing tool, permission denial, secret detection, partial collection, and low disk space.. Distinguish mitigation from root-cause correction.
