# Secure File Transfer Service: Acceptance Tests
...
Exercise: Bad directory ownership, full quota, expired key, attempted traversal, disabled account, service reload failure, and lost file.
