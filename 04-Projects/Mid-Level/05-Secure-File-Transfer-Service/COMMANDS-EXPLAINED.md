# Secure File Transfer Service: Commands Explained

The implementation uses commands appropriate to OpenSSH Match rules, chroot, identity, key lifecycle, filesystem policy, audit. For each command, document purpose, options, privilege, input, output, exit status, persistent change, rollback, and portability.
