# Highly Available Reverse Proxy: Acceptance Tests
...
Exercise: Backend loss, proxy restart, unhealthy-but-listening backend, TLS error, slow backend, log growth, and uneven load.
