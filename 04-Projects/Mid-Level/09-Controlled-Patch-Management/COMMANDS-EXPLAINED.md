# Controlled Patch Management: Commands Explained

The implementation uses commands appropriate to inventory, risk classification, canary selection, package history, validation, reboot review. For each command, document purpose, options, privilege, input, output, exit status, persistent change, rollback, and portability.
