# Caching DNS Resolver: Acceptance Tests
...
Exercise: Forwarder failure, stale cache, TCP fallback, blocked port 53, invalid DNSSEC, large response, and resolver overload.
