# LVM Storage Lifecycle: Acceptance Tests
...
Exercise: Missing device, full filesystem, inode pressure, snapshot full, mount failure, interrupted backup, and restore to new volume.
