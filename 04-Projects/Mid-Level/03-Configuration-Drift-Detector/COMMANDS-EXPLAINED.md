# Configuration Drift Detector: Commands Explained

The implementation uses commands appropriate to manifests, checksums, metadata, exclusions, comparison, scheduling, alert output. For each command, document purpose, options, privilege, input, output, exit status, persistent change, rollback, and portability.
