# Configuration Drift Detector: Acceptance Tests
...
Exercise: Legitimate change, deleted file, new file, mode change, symlink change, package replacement, and unreachable host.
