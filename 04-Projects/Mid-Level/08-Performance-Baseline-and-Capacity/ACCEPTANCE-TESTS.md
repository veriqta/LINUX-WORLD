# Performance Baseline and Capacity Study: Acceptance Tests
...
Exercise: CPU saturation, memory pressure, disk latency, connection limit, packet loss, warm-up effects, and noisy neighbor.
