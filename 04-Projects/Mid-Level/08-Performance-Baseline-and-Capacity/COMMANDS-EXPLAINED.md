# Performance Baseline and Capacity Study: Commands Explained

The implementation uses commands appropriate to workload definition, sampling, latency, saturation, headroom, bottleneck analysis. For each command, document purpose, options, privilege, input, output, exit status, persistent change, rollback, and portability.
