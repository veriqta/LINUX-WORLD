# Centralized Logging Service: Commands Explained

The implementation uses commands appropriate to event schema, transport, local queue, collector, retention, access, delivery monitoring. For each command, document purpose, options, privilege, input, output, exit status, persistent change, rollback, and portability.
