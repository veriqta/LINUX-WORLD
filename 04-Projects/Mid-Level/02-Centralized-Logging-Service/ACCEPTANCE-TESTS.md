# Centralized Logging Service: Acceptance Tests
...
Exercise: Collector unavailable, network partition, queue growth, malformed event, clock skew, duplicate delivery, and storage pressure.
