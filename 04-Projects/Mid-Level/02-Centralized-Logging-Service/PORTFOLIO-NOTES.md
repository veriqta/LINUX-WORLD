# Centralized Logging Service: Portfolio Notes
...
Be ready to explain how the system behaves during Collector unavailable, network partition, queue growth, malformed event, clock skew, duplicate delivery, and storage pressure.. Distinguish mitigation from root-cause correction.
