# Certificate and Secret Lifecycle Platform: Acceptance Tests
...
Exercise every listed condition: Expired intermediate, broken chain, stale trust store, failed reload, revoked credential, clock drift, and unavailable issuer.
