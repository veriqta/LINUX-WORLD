# cgroup Capacity Governance: Acceptance Tests
...
Exercise every listed condition: CPU throttling, memory OOM, PID exhaustion, I/O contention, priority inversion, host pressure, and invalid override.
