# Self-Healing Service Platform: Implementation Guide
...
Run functional, security, load, rollback, and game-day tests. Exercise crash loop, false health failure, dependency outage, split health view, restart-budget exhaustion, controller loss, and partial recovery.
