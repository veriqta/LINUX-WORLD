...
Run game days for: Crash loop, false health failure, dependency outage, split health view, exhausted restart budget, partial recovery, and controller failure.
