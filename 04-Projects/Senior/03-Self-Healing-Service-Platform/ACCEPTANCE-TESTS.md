# Self-Healing Service Platform: Acceptance Tests
...
Exercise every listed condition: Crash loop, false health failure, dependency outage, split health view, exhausted restart budget, partial recovery, and controller failure.
