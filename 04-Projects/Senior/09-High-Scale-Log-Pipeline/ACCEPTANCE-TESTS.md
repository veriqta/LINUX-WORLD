# High-Scale Log Pipeline: Acceptance Tests
...
Exercise every listed condition: Collector loss, downstream slowdown, queue full, malformed burst, duplicate replay, clock skew, and storage exhaustion.
