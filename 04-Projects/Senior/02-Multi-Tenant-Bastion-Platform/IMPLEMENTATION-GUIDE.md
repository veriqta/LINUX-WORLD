...
Run game days for: Identity provider loss, certificate expiry, audit storage full, tenant policy error, network partition, compromised key, and emergency access.
