# Disaster Recovery Automation: Acceptance Tests
...
Exercise every listed condition: Lost primary site, corrupted latest backup, missing secret, incompatible version, DNS cutover delay, partial restore, and failed fallback.
