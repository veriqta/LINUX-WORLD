# Linux Observability Platform: Acceptance Tests
...
Exercise every listed condition: Collector loss, backpressure, cardinality explosion, clock skew, storage pressure, alert storm, and silent data gap.
