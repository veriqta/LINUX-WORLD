# Linux Observability Platform: Implementation Guide
...
Run functional, security, load, rollback, and game-day tests. Exercise collector loss, backpressure, cardinality explosion, clock skew, storage pressure, alert storm, and silent data gap.
