# Fleet Bootstrap and Compliance: Acceptance Tests
...
Exercise every listed condition: Partial enrollment, stale policy, unreachable control plane, revoked host, clock skew, bad policy rollout, and conflicting local change.
