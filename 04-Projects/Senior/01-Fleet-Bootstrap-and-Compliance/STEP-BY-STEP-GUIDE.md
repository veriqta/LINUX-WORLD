# Fleet Bootstrap and Compliance: Implementation Guide
...
Run functional, security, load, rollback, and game-day tests. Exercise partial enrollment, stale policy, revoked host, clock skew, bad rollout, control-plane loss, and local drift.
