...
Run functional, security, load, rollback, and game-day tests. Exercise repository change, hardening failure, missing driver, expired certificate, boot regression, canary failure, and vulnerable image.
