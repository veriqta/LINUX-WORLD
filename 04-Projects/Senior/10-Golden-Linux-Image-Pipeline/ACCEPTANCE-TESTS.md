# Golden Linux Image Pipeline: Acceptance Tests
...
Exercise every listed condition: Repository change, failed hardening, missing driver, expired certificate, boot regression, canary failure, and vulnerable published image.
