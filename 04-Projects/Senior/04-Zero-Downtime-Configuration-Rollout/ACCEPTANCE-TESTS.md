# Zero-Downtime Configuration Rollout: Acceptance Tests
...
Exercise every listed condition: Invalid syntax, valid-but-harmful setting, canary signal delay, cohort drift, network partition, rollback failure, and mixed versions.
