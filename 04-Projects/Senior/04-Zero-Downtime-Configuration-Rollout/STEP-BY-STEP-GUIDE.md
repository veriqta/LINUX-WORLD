# Zero-Downtime Configuration Rollout: Implementation Guide
...
Run functional, security, load, rollback, and game-day tests. Exercise syntax error, valid-but-harmful setting, delayed signal, cohort drift, partition, rollback failure, and mixed versions.
