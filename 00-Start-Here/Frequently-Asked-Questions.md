...
Yes. The Learning Path begins with Linux foundations and builds progressively toward administration, troubleshooting, scripting, automation, security, and a complete final project.
...
## How long will the Learning Path take?
...
The Learning Path establishes the Linux knowledge needed before deeper DevOps and cloud specialization.
...
Part 20 is the capstone for the complete Learning Path. Additional Junior, Mid-Level, and Senior projects are provided in the Projects collection.
...
If the lab is ready and the safety guidance has been reviewed, begin [Part 1: Linux Foundations and Getting Started](../01-Learning-Path/01-Linux-Foundations-and-Getting-Started.md).
