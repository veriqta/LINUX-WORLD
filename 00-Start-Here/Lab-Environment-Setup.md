...
| --- | --- | --- |
| Virtual machine | Complete Learning Path and safe failure labs | Requires sufficient CPU, memory, and storage |
...
For the complete Learning Path, a virtual machine is the preferred starting point.
...
Read [Lab Safety](Lab-Safety.md) before running Learning Path commands.
