...
Record technical direction, stakeholder alignment and engineering follow-through.
...
### 1. Problem and organizational context
...
### 3. Technical position and evidence
...
### 4. Disagreement and decision process
...
### 5. Delegation, coaching and ownership
...
### 6. Outcome, lessons and follow-up
...
| Topic | Stakeholders | Technical evidence | Trade-off | Decision/commitment | Owner | Follow-through |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Record alignment, dissent, delegation, coaching, organizational risk and the results of prior commitments.
...
- [ ] Risk reviewed: Hero ownership.
- [ ] Risk reviewed: Invisible decisions.
- [ ] Risk reviewed: No dissent record.
- [ ] Risk reviewed: Credit without contributors.
