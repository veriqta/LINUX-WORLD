...
Model demand, bottlenecks, headroom and scaling lead time.
...
### 1. Workload units and growth scenarios
...
### 2. Resource demand per workload unit
...
### 3. Peak, tail and failure-mode capacity
...
### 4. Limits, queues and saturation
...
### 5. Scaling options, cost and lead time
...
### 6. Validation load test and review triggers
...
| Scenario | Workload driver | Assumption | Peak demand | Failure reserve | Capacity date | Confidence |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Model normal, peak and degraded modes; document unit economics, scaling limits and uncertainty.
...
- [ ] Risk reviewed: Linear scaling assumption.
- [ ] Risk reviewed: Ignoring degraded mode.
- [ ] Risk reviewed: No tail latency.
- [ ] Risk reviewed: Unsafe load test.
