...
Evaluate whether operational controls enable safe, accountable and efficient work.
...
### 2. Change and exception processes
...
### 3. Access and separation of duties
...
### 4. Reliability and security objectives
...
### 5. Evidence, audit and retention
...
### 6. Control effectiveness, burden and improvement
...
| Control/obligation | Scope | Owner | Evidence | Exception | Expiry | Effectiveness |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Assess whether policy produces reliable outcomes, not merely whether documents exist.
...
- [ ] Risk reviewed: Compliance equals safety.
- [ ] Risk reviewed: Control with no outcome.
- [ ] Risk reviewed: Permanent exception.
- [ ] Risk reviewed: Metrics easy to game.
