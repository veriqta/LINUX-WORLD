# Major Incident Decision Log

Record high-risk decisions, evidence and alternatives during an incident.
...
### 2. Situation and evidence available
...
### 5. Decision, execution and abort condition
...
| UTC | Decision | Alternatives | Evidence available | Risk accepted | Decision owner | Review trigger |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Record consequential choices in real time, including uncertainty, dissent and reversal conditions.
...
- [ ] Risk reviewed: Backdating decisions.
- [ ] Risk reviewed: No rejected option.
- [ ] Risk reviewed: Fact and assumption mixed.
- [ ] Risk reviewed: No review.
