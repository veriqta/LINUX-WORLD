# Game Day Observation Record

Measure detection, response and recovery during controlled failure.
...
### 1. Hypothesis and safety boundary
...
### 2. Authorized injection and abort
...
### 5. Recovery and integrity validation
...
### Resilience exercise worksheet

| Hypothesis | Injection | Expected detection/response | Observed | Gap | Evidence |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

| Safety boundary | Stop condition | Controller | Outcome |
| --- | --- | --- | --- |
|  |  |  |  |

**Coverage requirement:** Pre-authorize scope, protect production, distinguish exercise artifacts and convert gaps into owned actions.
...
- [ ] Risk reviewed: Unbounded injection.
- [ ] Risk reviewed: No kill switch.
- [ ] Risk reviewed: Testing without baseline.
- [ ] Risk reviewed: No cleanup.
