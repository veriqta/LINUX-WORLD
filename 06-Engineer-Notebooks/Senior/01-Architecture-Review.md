...
Evaluate whether a Linux platform design meets functional and operational requirements.
...
### 1. Context, users and critical journeys
...
### 2. Components, state and data flows
...
### 3. Trust and failure boundaries
...
### 4. Availability, performance and capacity
...
### 5. Operability, deployment and recovery
...
### 6. Alternatives, decisions and unresolved risks
...
| Component/data flow | Responsibility | Trust boundary | Dependency | Failure mode | Control/evidence |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

**Coverage requirement:** Evaluate interfaces, ownership, data lifecycle, failure domains, operability, security and evolution constraints.
...
- [ ] Risk reviewed: Diagram without flows.
- [ ] Risk reviewed: Shared hidden dependency.
- [ ] Risk reviewed: No ownership.
- [ ] Risk reviewed: No validation plan.
