...
Quantify how a change or failure can propagate and define containment.
...
### 1. Initiating event and assumptions
...
### 2. Affected users, systems and data
...
### 3. Shared dependencies and correlated failure
...
### 4. Privilege and control-plane reach
...
### 6. Residual risk, owner and review date
...
| Failure/change | Affected boundary | Maximum impact | Propagation path | Containment | Detection | Residual risk |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Quantify exposure by tenant, region, zone, host, identity, data and time; define automatic stop conditions.
...
- [ ] Risk reviewed: Calling risk low without evidence.
- [ ] Risk reviewed: Missing downstreams.
- [ ] Risk reviewed: No worst case.
- [ ] Risk reviewed: No containment test.
