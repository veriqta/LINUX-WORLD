...
Decide whether a service can be safely launched and supported.
...
### 1. Service ownership and support model
...
### 2. SLOs, capacity and dependencies
...
### 4. Observability and alert response
...
### 5. Deployment, rollback and change control
...
### 6. Backup, recovery, runbooks and launch gates
...
| Domain | Release criterion | Evidence | Risk/gap | Owner | Decision |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

**Coverage requirement:** Gate reliability, capacity, security, observability, support, deployment, rollback, backup, recovery and compliance.
...
- [ ] Risk reviewed: Launch by date only.
- [ ] Risk reviewed: Untested rollback.
- [ ] Risk reviewed: Alerts without owner.
- [ ] Risk reviewed: No restore evidence.
