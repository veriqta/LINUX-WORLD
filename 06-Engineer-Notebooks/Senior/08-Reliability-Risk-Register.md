...
Maintain actionable reliability risks with evidence, ownership and treatment.
...
### 1. Failure scenario and affected objective
...
### 2. Likelihood and impact evidence
...
### 3. Current prevention and detection
...
### 4. Recovery control and tested status
...
### 5. Treatment, priority and owner
...
### 6. Acceptance reason and expiry
...
| Risk | Failure mode | Likelihood | Impact | Detectability | Controls | Residual risk | Owner/review |
| --- | --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |  |

**Coverage requirement:** Track assumptions, correlated failures, control effectiveness, accepted risk and time-bound review.
...
- [ ] Risk reviewed: Risk with no scenario.
- [ ] Risk reviewed: Permanent acceptance.
- [ ] Risk reviewed: No effectiveness test.
- [ ] Risk reviewed: Duplicate unowned risks.
