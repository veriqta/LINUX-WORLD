...
Review assets, trust boundaries, abuse paths and host controls.
...
### 2. Actors, capabilities and entry points
...
### 5. Containment, forensic and recovery needs
...
### 6. Residual risk and verification
...
| Asset/data flow | Trust boundary | Threat | Abuse path | Prevent/detect/respond controls | Residual risk |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

**Coverage requirement:** Include identity, supply chain, secrets, isolation, logging, availability, data lifecycle and incident response.
...
- [ ] Risk reviewed: Checklist without threat.
- [ ] Risk reviewed: Firewall-only defense.
- [ ] Risk reviewed: No recovery.
- [ ] Risk reviewed: Unowned residual risk.
