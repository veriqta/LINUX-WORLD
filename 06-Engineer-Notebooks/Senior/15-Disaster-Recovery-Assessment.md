...
Evaluate whether people, systems and data can recover from site-level loss.
...
### 1. Disaster assumptions and unavailable dependencies
...
### 3. Backup isolation and key availability
...
### 4. Recovery environment and sequencing
...
### 5. Data integrity and business validation
...
### 6. Exercise results, gaps and investment decisions
...
| Service/data set | Failure scope | RPO/RTO | Recovery sequence | Dependency | Last proof | Gap |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Validate people, access, infrastructure, data, integrity, security, traffic restoration and return-to-normal.
...
- [ ] Risk reviewed: Backup in same failure domain.
- [ ] Risk reviewed: No identity recovery.
- [ ] Risk reviewed: Paper-only plan.
- [ ] Risk reviewed: No capacity in recovery site.
