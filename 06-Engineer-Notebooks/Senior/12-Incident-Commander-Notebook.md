# Incident Commander Notebook

Coordinate a major incident through roles, decisions, communication and recovery.
...
### 1. Severity, impact and objectives
...
### 2. Command roles and communication cadence
...
### 3. Known facts, unknowns and hypotheses
...
### 4. Mitigations and risk decisions
...
### 5. Recovery criteria and validation
...
### 6. Handover, postmortem and action ownership
...
| Role | Assigned person/role | Responsibility | Channel | Backup |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |

| UTC | SITREP: impact, actions, risk, next update | Decision owner |
| --- | --- | --- |
|  |  |  |

**Coverage requirement:** Protect command span, establish cadence, separate investigation from coordination and record recovery criteria.
...
- [ ] Risk reviewed: Commander debugging alone.
- [ ] Risk reviewed: No decision log.
- [ ] Risk reviewed: Premature root cause.
- [ ] Risk reviewed: Recovery without users.
