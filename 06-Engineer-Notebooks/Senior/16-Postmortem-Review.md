...
Assess whether an incident review is accurate, blameless and likely to reduce future risk.
...
### 3. Trigger and systemic contributors
...
### 6. Effectiveness review and organizational learning
...
### Postmortem quality worksheet

| Claim/factor | Evidence | Causal role | Control gap | Corrective action |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |

| Action | Risk reduced | Owner | Due | Verification | Status |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

**Coverage requirement:** Require a defensible timeline, causal reasoning, contributing conditions, learning and measurable prevention.
...
- [ ] Risk reviewed: Single root cause.
- [ ] Risk reviewed: Blame language.
- [ ] Risk reviewed: Actions like be careful.
- [ ] Risk reviewed: No follow-up.
