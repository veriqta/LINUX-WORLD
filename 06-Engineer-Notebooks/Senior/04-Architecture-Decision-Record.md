...
Preserve one significant decision, alternatives and consequences.
...
### 6. Validation, reversal and supersession
...
| Option | Benefits | Costs | Risks | Reversibility | Evidence | Reason rejected/selected |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Capture context, constraints, decision, consequences, dissent, review trigger and migration implications.
...
- [ ] Risk reviewed: Tool-first decision.
- [ ] Risk reviewed: No rejected alternatives.
- [ ] Risk reviewed: Hidden cost.
- [ ] Risk reviewed: No reversal path.
