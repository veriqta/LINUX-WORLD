...
Connect Linux service reliability to user-visible objectives and change decisions.
...
### 2. SLI definition and data quality
...
### 3. Target and measurement window
...
### 4. Budget consumption and burn rates
...
### 6. Exclusions, risks and improvement plan
...
| User journey | SLI definition | Data source | SLO/window | Current result | Budget remaining | Policy action |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Validate measurement coverage, exclusions, burn rates, dependencies and the decision policy triggered by budget consumption.
...
- [ ] Risk reviewed: Infrastructure metric as user SLI.
- [ ] Risk reviewed: Unbounded exclusions.
- [ ] Risk reviewed: No data-quality check.
- [ ] Risk reviewed: SLO with no action.
