...
Establish a reproducible normal-state reference for comparison and capacity decisions.
...
### 2. Software, kernel and configuration versions
...
### 3. CPU, memory, IO and network baseline
...
### 4. Service, dependency and security state
...
### 5. Normal logs, error rate and latency
...
### 6. Collection method, time window and validity limits
...
| Domain | Metric/configuration | Collection method | Normal range | Observed | Variance | Evidence |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Include workload context, collection interval, software versions and known exceptions so future comparisons are valid.
...
- [ ] Risk reviewed: Baseline during incident.
- [ ] Risk reviewed: Averages without percentiles.
- [ ] Risk reviewed: Unknown workload.
- [ ] Risk reviewed: No expiration date.
