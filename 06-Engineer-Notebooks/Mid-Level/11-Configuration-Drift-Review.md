...
Distinguish approved exceptions from uncontrolled differences and restore governance.
...
### 3. File, package, service and kernel drift
...
### 4. Approved exception and expiry
...
### 6. Remediation, prevention and verification
...
| Object | Desired source | Desired value/hash | Observed | Cause | Risk | Remediation |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Separate authorized exception, emergency change, tool failure and unauthorized drift; reconcile source of truth.
...
- [ ] Risk reviewed: Comparing only files.
- [ ] Risk reviewed: Deleting valid exception.
- [ ] Risk reviewed: No owner.
- [ ] Risk reviewed: No root cause.
