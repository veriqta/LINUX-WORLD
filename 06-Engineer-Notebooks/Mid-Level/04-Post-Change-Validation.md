...
Prove the requested result, safety controls and persistence after change.
...
### 1. Deployed version and effective configuration
...
### 3. Negative and authorization tests
...
### 4. Logs, metrics and resource impact
...
### 5. Dependency and downstream health
...
### 6. Reboot, rollback and observation-window result
...
| Signal | Before | Expected after | Observed after | Evidence | Result | Follow-up |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Test user workflow, negative behavior, security, dependencies, performance, logs, alerts and persistence.
...
- [ ] Risk reviewed: Checking only process state.
- [ ] Risk reviewed: No baseline comparison.
- [ ] Risk reviewed: Short observation window.
- [ ] Risk reviewed: Ignoring denied behavior.
