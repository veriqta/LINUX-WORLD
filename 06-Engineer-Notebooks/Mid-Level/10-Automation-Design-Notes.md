...
Design repeatable administration that fails safely and remains maintainable.
...
### 2. Inputs, outputs and interfaces
...
### 3. Idempotence and partial-run behavior
...
### 4. Privilege, secrets and validation
...
### 5. Concurrency, locking and atomicity
...
### 6. Tests, observability, rollback and ownership
...
| Input | Type/constraint | Default | Validation | Secret handling |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |

| Scenario | Expected state | Idempotency result | Failure behavior | Test evidence |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |

**Coverage requirement:** Define interfaces, privileges, dry-run behavior, idempotency, concurrency, observability, rollback and tests.
...
- [ ] Risk reviewed: Unquoted input.
- [ ] Risk reviewed: Predictable temp file.
- [ ] Risk reviewed: Embedded secret.
- [ ] Risk reviewed: No partial failure plan.
