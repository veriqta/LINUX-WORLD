...
Separate demand, utilization, saturation and latency before recommending tuning.
...
### 1. User symptom and performance objective
...
### 3. CPU run queue, steal and throttling
...
### 4. Memory pressure, reclaim and swap
...
### 5. Storage latency, queue and throughput
...
### 6. Network, dependency and application evidence
...
| Layer | Signal | Baseline | Observed | Saturation/error indicator | Evidence |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

| Hypothesis | Controlled test | Expected distinction | Observed | Conclusion |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |

**Coverage requirement:** Correlate demand, latency, throughput, errors and saturation across CPU, memory, storage, network and application layers.
...
- [ ] Risk reviewed: Tuning before measuring.
- [ ] Risk reviewed: Single snapshot.
- [ ] Risk reviewed: Clearing cache as fix.
- [ ] Risk reviewed: Moving bottleneck.
