...
Record a service release from artifact verification through operational acceptance.
...
### 1. Artifact identity, source and signature
...
### 2. Configuration and secret references
...
### 3. Service identity and filesystem ownership
...
### 4. Unit, dependencies and resource controls
...
### 5. Health, logs, metrics and alerts
...
### 6. Canary, rollout, rollback and final acceptance
...
### Deployment gate worksheet

| Artifact/config | Version/hash | Source | Promotion approval | Deployed target | Verification |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

| Stage | Health gate | Observation window | Abort threshold | Outcome |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |

**Coverage requirement:** Preserve artifact identity, configuration provenance, staged rollout, database compatibility and rollback evidence.
...
- [ ] Risk reviewed: Mutable untracked artifact.
- [ ] Risk reviewed: Secret in repository.
- [ ] Risk reviewed: Root service account.
- [ ] Risk reviewed: No rollback rehearsal.
