...
Prove readiness before changing a service or host.
...
### 2. Current health and open incidents
...
### 3. Backup or snapshot readiness
...
### 4. Capacity and dependency health
...
### 5. Configuration syntax and artifact integrity
...
### 6. Monitoring, access and rollback readiness
...
| Requirement | Method | Expected | Observed | Evidence | Gate result | Exception owner |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Validate backup, capacity, dependencies, monitoring, access, rollback materials and change-window readiness.
...
- [ ] Risk reviewed: Changing unhealthy system.
- [ ] Risk reviewed: Stale backup.
- [ ] Risk reviewed: No console access.
- [ ] Risk reviewed: Unverified artifact.
