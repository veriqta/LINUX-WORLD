...
Create an evidence-based UTC sequence of impact, detection, decisions and recovery.
...
### 3. Recent changes and hypotheses
...
### 5. Mitigation and decision points
...
### 6. Recovery, validation and follow-up
...
| UTC time | Source | Raw fact | Interpretation | Confidence | Impact | Evidence ID |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Normalize clocks, distinguish detection from onset, and mark inferred times and evidence gaps.
...
- [ ] Risk reviewed: Local timezone mix.
- [ ] Risk reviewed: Backfilled guesses as facts.
- [ ] Risk reviewed: Missing decision owner.
- [ ] Risk reviewed: No end time.
