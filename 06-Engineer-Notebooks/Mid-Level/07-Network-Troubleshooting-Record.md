# Network Troubleshooting Record

Trace an affected flow across name, route, firewall, transport and application layers.
...
### 1. Five-tuple and affected source
...
### 2. DNS answer and resolver used
...
### 5. Socket state and packet evidence
...
### 6. TLS, application response and return path
...
### Network flow worksheet

| Hop/layer | Source and destination | Expected path | Observed path | Loss/latency | Policy | Evidence |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Include namespaces, routes, neighbor state, MTU, DNS, firewall, socket, TLS and application checks.
...
- [ ] Risk reviewed: One-sided capture.
- [ ] Risk reviewed: Ignoring MTU.
- [ ] Risk reviewed: Testing different network.
- [ ] Risk reviewed: Exposing packet secrets.
