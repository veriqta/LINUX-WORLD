...
Explain why an incident occurred and why controls allowed its impact.
...
### 2. Trigger versus contributing conditions
...
### 6. Corrective actions and effectiveness tests
...
| Factor | Evidence | Necessary/contributing/latent | Control that failed | Correction |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |

| Action | Cause addressed | Owner | Due | Verification | Status |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

**Coverage requirement:** Go beyond the trigger. Identify technical, process and detection factors without assigning blame.
...
- [ ] Risk reviewed: Single-person blame.
- [ ] Risk reviewed: Five whys without evidence.
- [ ] Risk reviewed: Root cause before proof.
- [ ] Risk reviewed: Actions with no owner.
