...
Transfer service ownership with enough information to operate and recover it.
...
### 3. Deployment and configuration path
...
### 4. Health, alerts and dashboards
...
### 5. Runbooks, backup and recovery
...
### 6. Risks, access, support and acceptance
...
### Service acceptance worksheet

| Area | Required artifact/control | Owner | Evidence | Gap | Acceptance decision |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

**Coverage requirement:** Cover ownership, dependencies, SLOs, dashboards, alerts, runbooks, access, backup, recovery, capacity and known risk.
...
- [ ] Risk reviewed: Documentation without validation.
- [ ] Risk reviewed: Hidden manual step.
- [ ] Risk reviewed: Missing access.
- [ ] Risk reviewed: No acceptance sign-off.
