...
Convert an approved change into sequenced, testable and recoverable work.
...
### 3. Risk, blast radius and maintenance window
...
### 4. Implementation steps and checkpoints
...
### 6. Communication and review ownership
...
| Phase | Dependency | Action | Validation gate | Abort threshold | Rollback | Owner |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Map dependencies, freeze conditions, communication points, checkpoints and rollback compatibility.
...
- [ ] Risk reviewed: Hidden dependency.
- [ ] Risk reviewed: No stop condition.
- [ ] Risk reviewed: Rollback incompatible with data.
- [ ] Risk reviewed: Unbounded concurrency.
