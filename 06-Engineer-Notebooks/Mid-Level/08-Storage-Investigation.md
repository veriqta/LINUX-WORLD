...
Investigate capacity, latency and integrity across the storage stack.
...
### 1. Device, mapper, RAID and LVM topology
...
### 3. Blocks, inodes, quota and snapshots
...
### 4. Latency, queue depth and workload
...
### 5. Kernel, device and filesystem errors
...
### 6. Data protection, repair boundary and recovery
...
### Storage-stack worksheet

| Layer | Object | Expected state | Observed state | Latency/errors | Capacity | Evidence |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Trace device, multipath/RAID, volume manager, filesystem, mount, process I/O and data durability.
...
- [ ] Risk reviewed: Repair before imaging.
- [ ] Risk reviewed: Snapshot overflow.
- [ ] Risk reviewed: Wrong device.
- [ ] Risk reviewed: Ignoring multipath.
