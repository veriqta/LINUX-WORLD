...
Translate workload growth into resource headroom and action thresholds.
...
### 2. CPU, memory, storage, inode and network trends
...
### 5. Headroom and exhaustion date
...
### 6. Scale action, lead time and verification
...
| Resource | Current demand | Usable capacity | Headroom | Growth rate | Exhaustion date | Action threshold |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** State workload driver, seasonality, redundancy reserve, failure-mode capacity and forecast uncertainty.
...
- [ ] Risk reviewed: Straight-line assumption.
- [ ] Risk reviewed: Average-only planning.
- [ ] Risk reviewed: Missing quotas.
- [ ] Risk reviewed: No procurement lead time.
