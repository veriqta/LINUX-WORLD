...
Plan and record a bounded change with explicit validation and rollback.
...
### 1. Reason, scope and authorization
...
### 5. Validation and abort conditions
...
### 6. Rollback steps and final state
...
### Change execution worksheet

| Step | Precondition | Action | Success signal | Abort condition | Rollback step | Owner |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Tie every change step to a checkpoint, measurable success signal and safe rollback.
...
- [ ] Risk reviewed: No rollback trigger.
- [ ] Risk reviewed: Multiple unrelated changes.
- [ ] Risk reviewed: No negative test.
- [ ] Risk reviewed: No persistence test.
