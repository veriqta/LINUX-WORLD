...
Record a consistent health review without turning normal variation into an incident.
...
### 1. Availability and failed services
...
### 3. Disk blocks, inodes and mount health
...
### 4. Network interfaces, routes and listening services
...
### 5. Recent warnings, reboots and time synchronization
...
### 6. Backup, monitoring and scheduled-job status
...
| Component | Expected state | Observed state | Evidence ID | Status | Escalation |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

**Coverage requirement:** Cover availability, failed units, resource pressure, filesystems, networking, time, backups, monitoring and scheduled jobs.
...
- [ ] Risk reviewed: Missing a failed timer.
- [ ] Risk reviewed: Calling cached memory a fault.
- [ ] Risk reviewed: Ignoring inode exhaustion.
- [ ] Risk reviewed: Collecting sensitive logs.
