...
Record access changes and prove both allowed and denied behavior.
...
### 1. Requested access and data owner approval
...
### 2. Current owner, group, mode and ACL
...
### 4. Proposed chmod, chown or ACL change
...
### 5. Effect of umask and inherited group behavior
...
### 6. Authorized and unauthorized identity tests
...
| Path | Current owner:group | Current mode/ACL | Proposed state | Reason | Rollback |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

| Test identity | Operation | Expected allow/deny | Observed | Evidence |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |

**Coverage requirement:** Inspect every path component, ACL, umask, special bit and mandatory-access-control context before changing access.
...
- [ ] Risk reviewed: Using chmod 777.
- [ ] Risk reviewed: Ignoring ACL mask.
- [ ] Risk reviewed: Changing recursively without scope.
- [ ] Risk reviewed: Testing only as root.
