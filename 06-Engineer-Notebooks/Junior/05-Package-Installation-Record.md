...
Document software origin, dependencies, configuration and removal path.
...
### 1. Business and technical reason
...
### 2. Distribution repository and package signature
...
### 3. Candidate and installed version
...
### 4. Dependencies and files installed
...
### 5. Services, ports and configuration introduced
...
### 6. Verification, update owner and removal procedure
...
### Package lifecycle worksheet

| Package | Repository/source | Signature verified | Version | Dependencies | Files/services introduced |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

| Validation | Expected | Observed | Evidence | Removal step |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |

**Coverage requirement:** Document trusted source, exact version, dependency impact, service activation, configuration, verification and uninstall plan.
...
- [ ] Risk reviewed: Untrusted repository.
- [ ] Risk reviewed: Disabling signature checks.
- [ ] Risk reviewed: Unexpected service activation.
- [ ] Risk reviewed: Removing shared dependencies.
