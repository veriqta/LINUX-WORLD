...
Transfer operational context without relying on memory or private conversation.
...
### 3. Changes completed or in progress
...
### 4. Alerts, risks and temporary mitigations
...
### 6. Owners, escalation and next required action
...
| Service/work item | Current state | Recent change | Temporary measure | Next action | Owner | Due UTC |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

| Risk or unknown | Impact | Evidence link | Escalation trigger | Contact role |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |

**Coverage requirement:** Separate completed work, active risk and pending action. The receiving engineer must be able to act without oral context.
...
- [ ] Risk reviewed: Vague status.
- [ ] Risk reviewed: Missing timestamps.
- [ ] Risk reviewed: No named owner.
- [ ] Risk reviewed: Sharing credentials.
