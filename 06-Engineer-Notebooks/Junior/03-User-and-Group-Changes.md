...
Document account creation, modification, suspension and removal with least privilege.
...
### 1. Identity request and authorization
...
### 2. UID, primary group and supplementary groups
...
### 3. Login shell, home directory and expiration
...
### 4. SSH keys and authentication source
...
### 5. Sudo entitlement and separation of duties
...
### 6. Removal, file ownership and session review
...
### Identity change worksheet

| Identity | UID/GID | Current groups | Requested groups | Login method | Sudo scope | Approver |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

| Access test | Expected identity | Expected result | Observed | Evidence |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |

**Coverage requirement:** Trace the request, authorization, least privilege, active sessions, owned files and removal or expiry.
...
- [ ] Risk reviewed: UID collision.
- [ ] Risk reviewed: Broad sudo access.
- [ ] Risk reviewed: Deleting before ownership review.
- [ ] Risk reviewed: Leaving active credentials.
