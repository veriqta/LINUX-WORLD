...
Record safe service start, stop, enablement, configuration and health validation.
...
### 1. Unit name and service purpose
...
### 5. Start, stop, reload and restart impact
...
### 6. Process, socket, logs and end-to-end health
...
### Service control worksheet

| Unit | Load/active state | Enablement | Dependencies | Drop-ins | Runtime identity |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

| Check | Config validation | Socket | Logs | End-to-end | Reboot persistence |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |

**Coverage requirement:** Record unit provenance, configuration validation, dependencies, runtime user, sockets, logs, restart policy and boot behavior.
...
- [ ] Risk reviewed: Blind restart.
- [ ] Risk reviewed: Editing vendor unit.
- [ ] Risk reviewed: Confusing enable with start.
- [ ] Risk reviewed: Checking only active state.
