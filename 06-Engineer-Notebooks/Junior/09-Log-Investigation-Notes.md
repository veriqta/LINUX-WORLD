...
Preserve a bounded log investigation with timestamps, interpretation and privacy controls.
...
### 1. Question the logs must answer
...
### 3. Hosts, units and files searched
...
### 5. Relevant events and surrounding context
...
### 6. Redactions, gaps and retention limits
...
### Log review worksheet

| UTC window | Source | Query/filter | Event summary | Context lines | Evidence ID | Redaction |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** State timezone, clock confidence, retention gaps and query scope. Preserve context without publishing secrets or personal data.
...
- [ ] Risk reviewed: Dumping unrestricted logs.
- [ ] Risk reviewed: Ignoring clock drift.
- [ ] Risk reviewed: Selecting only confirming evidence.
- [ ] Risk reviewed: Treating messages as root cause.
