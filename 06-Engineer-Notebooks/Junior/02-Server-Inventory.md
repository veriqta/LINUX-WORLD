...
Create a current, reproducible record of a Linux host and its operational ownership.
...
### 1. System purpose and service owner
...
### 2. Distribution, kernel, architecture and lifecycle status
...
### 3. CPU, memory, storage and network interfaces
...
### 4. Packages, repositories and important runtimes
...
### 5. Services, ports, mounts and scheduled work
...
### 6. Dependencies, backup, monitoring and access paths
...
| Asset field | Authoritative value | Discovery source | Verified UTC | Owner |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |

| Service or port | Bind address | Business purpose | Owner | Exposure approved |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |

**Coverage requirement:** Record identity, hardware, OS, storage, interfaces, installed roles, backup, monitoring, lifecycle and ownership.
...
- [ ] Risk reviewed: Publishing real addresses.
- [ ] Risk reviewed: Recording secrets.
- [ ] Risk reviewed: Treating inventory as permanent.
- [ ] Risk reviewed: Missing virtual or attached storage.
