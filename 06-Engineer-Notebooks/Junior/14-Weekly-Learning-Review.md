...
Turn operational work into verified learning without copying sensitive information.
...
### 4. Mistakes and corrected assumptions
...
### Learning evidence worksheet

| Work performed | Concept learned | Evidence | Mistake or uncertainty | Correction | Next lab | Target date |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |

**Coverage requirement:** Convert experience into a testable next step; do not claim mastery without evidence.
...
- [ ] Risk reviewed: Recording confidential data.
- [ ] Risk reviewed: Claiming untested mastery.
- [ ] Risk reviewed: Listing commands without explanation.
- [ ] Risk reviewed: No follow-up practice.
