...
This article explains availability zones and failure domains from the Linux operations perspective. It focuses on the host, identities, processes, files, network, storage, automation, telemetry and recovery responsibilities that make the capability safe to operate.
...
1. What Linux responsibility remains when using availability zones and failure domains?
