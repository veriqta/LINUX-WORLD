# Fleet Health and Convergence

This article explains fleet health and convergence from the Linux operations perspective. It focuses on the host, identities, processes, files, network, storage, automation, telemetry and recovery responsibilities that make the capability safe to operate.
...
- Name the authoritative source and who may update it.
- Detect out-of-band change and reconcile through the owning workflow.
- Repeated execution should not create unintended change.
...
1. What Linux responsibility remains when using fleet health and convergence?
