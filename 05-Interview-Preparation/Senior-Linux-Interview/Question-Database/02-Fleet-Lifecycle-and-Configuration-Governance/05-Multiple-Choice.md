# Fleet Lifecycle and Configuration Governance: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate golden image safely. What is the best first approach?

A. Restart the service immediately

B. Run `systemd-delta`, define the expected evidence and preserve the before state
...
## 2. A bootstrap change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in desired state. What should be tested next?
...
## 4. Which result best proves recovery of drift?
...
## 5. A measurement related to rollout ring is high. What is the best interpretation?
...
## 6. Which change practice is safest for immutable versus mutable hosts?
...
## 7. A candidate needs to investigate inventory and decommissioning safely. What is the best first approach?

A. Restart the service immediately

B. Run `journalctl --verify`, define the expected evidence and preserve the before state
