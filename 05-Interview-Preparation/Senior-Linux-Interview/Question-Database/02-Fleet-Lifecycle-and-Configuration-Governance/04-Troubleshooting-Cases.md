# Fleet Lifecycle and Configuration Governance: Troubleshooting Cases
...
**Domain evidence:** `systemd-delta`, `rpm -Va`, `debsums -s`, `osqueryi`, `ansible-inventory --graph`, `git diff`, `journalctl --verify`
