# Fleet Lifecycle and Configuration Governance: True or False

## 1. If a command related to golden image exits successfully, the complete requirement is proven.
