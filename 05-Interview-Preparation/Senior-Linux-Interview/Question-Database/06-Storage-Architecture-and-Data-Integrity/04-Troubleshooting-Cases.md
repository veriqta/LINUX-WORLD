# Storage Architecture and Data Integrity: Troubleshooting Cases
...
**Domain evidence:** `lsblk -o NAME,KNAME,TYPE,FSTYPE,MOUNTPOINTS`, `multipath -ll`, `mdadm --detail`, `dmsetup ls --tree`, `iostat -xz`, `smartctl -a`
