# Storage Architecture and Data Integrity: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate block stack safely. What is the best first approach?

A. Restart the service immediately

B. Run `lsblk -o NAME,KNAME,TYPE,FSTYPE,MOUNTPOINTS`, define the expected evidence and preserve the before state
...
## 2. A multipath change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in RAID. What should be tested next?
...
## 4. Which result best proves recovery of LVM?
...
## 5. A measurement related to filesystem journal is high. What is the best interpretation?
...
## 6. Which change practice is safest for write cache?
...
## 7. A candidate needs to investigate barriers safely. What is the best first approach?
...
## 8. A latency change works now but must survive reboot. Which evidence is strongest?
...
## 9. Users are denied while an administrator succeeds in corruption and durability. What should be tested next?
