# Incident Command and Recovery: Troubleshooting Cases
...
**Domain evidence:** `date -u +%FT%TZ`, `last -x`, `journalctl --since`, `dmesg -T`, `ss`, `ip`, `lsof`, `package history`, `configuration diff`
