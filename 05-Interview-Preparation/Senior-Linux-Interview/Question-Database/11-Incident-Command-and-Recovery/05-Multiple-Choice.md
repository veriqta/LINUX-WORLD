# Incident Command and Recovery: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate severity safely. What is the best first approach?

A. Restart the service immediately

B. Run `date -u +%FT%TZ`, define the expected evidence and preserve the before state
...
## 2. A roles change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in timeline. What should be tested next?
...
## 4. Which result best proves recovery of evidence?
...
## 5. A measurement related to containment is high. What is the best interpretation?
...
## 6. Which change practice is safest for mitigation?
...
## 7. A candidate needs to investigate recovery safely. What is the best first approach?

A. Restart the service immediately

B. Run `lsof`, define the expected evidence and preserve the before state
...
## 8. A communication change works now but must survive reboot. Which evidence is strongest?
...
## 9. Users are denied while an administrator succeeds in decision log and postmortem. What should be tested next?
