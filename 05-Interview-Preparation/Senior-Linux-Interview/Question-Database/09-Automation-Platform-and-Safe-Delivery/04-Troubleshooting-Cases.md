# Automation Platform and Safe Delivery: Troubleshooting Cases
...
**Domain evidence:** `ansible-playbook --check --diff`, `systemd-analyze verify`, `conftest test`, `cosign verify`, `git verify-commit`, `bats`, `pytest`
