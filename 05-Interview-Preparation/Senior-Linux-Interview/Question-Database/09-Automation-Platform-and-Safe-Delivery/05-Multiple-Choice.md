# Automation Platform and Safe Delivery: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate control plane safely. What is the best first approach?

A. Restart the service immediately

B. Run `ansible-playbook --check --diff`, define the expected evidence and preserve the before state
...
## 2. A convergence change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in idempotence. What should be tested next?
...
## 4. Which result best proves recovery of policy?
...
## 5. A measurement related to test pyramid is high. What is the best interpretation?
...
## 6. Which change practice is safest for artifact provenance?
...
## 7. A candidate needs to investigate canary safely. What is the best first approach?

A. Restart the service immediately

B. Run `pytest`, define the expected evidence and preserve the before state
...
## 8. A feature flag and rollback change works now but must survive reboot. Which evidence is strongest?
