# Linux Architecture and Kernel Behavior: Troubleshooting Cases
...
**Domain evidence:** `strace -f -ttT -p PID`, `perf top`, `slabtop`, `numastat`, `cat /proc/PID/smaps_rollup`, `bpftool prog list`, `sysctl -a`
