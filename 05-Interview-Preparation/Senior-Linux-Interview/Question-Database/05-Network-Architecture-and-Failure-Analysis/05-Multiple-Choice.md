# Network Architecture and Failure Analysis: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate routing domains safely. What is the best first approach?

A. Restart the service immediately

B. Run `ip route get`, define the expected evidence and preserve the before state
...
## 2. A ECMP change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in conntrack. What should be tested next?
...
## 4. Which result best proves recovery of NAT?
...
## 5. A measurement related to MTU is high. What is the best interpretation?
...
## 6. Which change practice is safest for offload?
...
## 7. A candidate needs to investigate queues safely. What is the best first approach?

A. Restart the service immediately

B. Run `tracepath`, define the expected evidence and preserve the before state
...
## 8. A DNS change works now but must survive reboot. Which evidence is strongest?
...
## 9. Users are denied while an administrator succeeds in TLS. What should be tested next?
...
## 10. Which result best proves recovery of load balancing and asymmetric paths?
