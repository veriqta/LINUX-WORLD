# Network Architecture and Failure Analysis: Troubleshooting Cases
...
**Domain evidence:** `ip route get`, `ss -ti`, `nstat`, `ethtool -S IFACE`, `conntrack -S`, `tcpdump`, `tracepath`, `dig +trace`, `openssl s_client`
