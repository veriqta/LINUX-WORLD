# Deep Performance and Resource Isolation: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate scheduler classes safely. What is the best first approach?

A. Restart the service immediately

B. Run `ps -eLo pid,tid,psr,cls,rtprio,ni,stat,comm`, define the expected evidence and preserve the before state
...
## 2. A CPU affinity change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in NUMA locality. What should be tested next?
...
## 4. Which result best proves recovery of huge pages?
...
## 5. A measurement related to memory reclaim is high. What is the best interpretation?
...
## 6. Which change practice is safest for IO schedulers?
...
## 7. A candidate needs to investigate cgroup v2 and PSI safely. What is the best first approach?
