# Deep Performance and Resource Isolation: Troubleshooting Cases
...
**Domain evidence:** `ps -eLo pid,tid,psr,cls,rtprio,ni,stat,comm`, `taskset -cp PID`, `numastat -p PID`, `memory.stat`, `io.stat`, `perf record`
