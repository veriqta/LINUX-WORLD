# Observability and Evidence Strategy: Troubleshooting Cases
...
**Domain evidence:** `journalctl -o json`, `coredumpctl info`, `prometheus query examples`, `bpftrace`, `sar`, `chronyc sources`, `sha256sum EVIDENCE`
