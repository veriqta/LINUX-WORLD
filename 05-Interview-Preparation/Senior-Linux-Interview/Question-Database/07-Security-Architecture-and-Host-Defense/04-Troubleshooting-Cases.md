# Security Architecture and Host Defense: Troubleshooting Cases
...
**Domain evidence:** `mokutil --sb-state`, `sysctl`, `getcap -r PATH`, `systemd-analyze security`, `ausearch`, `auditctl -l`, `keyctl show`, `package verification`
