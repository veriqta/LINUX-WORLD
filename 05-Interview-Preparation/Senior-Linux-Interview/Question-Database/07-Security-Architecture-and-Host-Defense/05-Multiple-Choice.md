# Security Architecture and Host Defense: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate identity boundary safely. What is the best first approach?

A. Restart the service immediately

B. Run `mokutil --sb-state`, define the expected evidence and preserve the before state
...
## 2. A privilege path change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in secure boot. What should be tested next?
...
## 4. Which result best proves recovery of kernel hardening?
...
## 5. A measurement related to MAC is high. What is the best interpretation?
...
## 6. Which change practice is safest for secrets?
...
## 7. A candidate needs to investigate audit safely. What is the best first approach?

A. Restart the service immediately

B. Run `keyctl show`, define the expected evidence and preserve the before state
...
## 8. A integrity change works now but must survive reboot. Which evidence is strongest?
...
## 9. Users are denied while an administrator succeeds in supply chain and response. What should be tested next?
