# Architecture Leadership and Trade-offs: Troubleshooting Cases
...
**Domain evidence:** `architecture decision records, threat models, SLO documents, capacity models, game-day reports and runbooks`
