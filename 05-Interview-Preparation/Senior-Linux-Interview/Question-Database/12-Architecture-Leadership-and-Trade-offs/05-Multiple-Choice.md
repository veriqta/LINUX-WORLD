# Architecture Leadership and Trade-offs: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate requirements safely. What is the best first approach?

A. Restart the service immediately

B. Run `architecture decision records, threat models, SLO documents, capacity models, game-day reports and runbooks`, define the expected evidence and preserve the before state
...
## 2. A constraints change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in failure domains. What should be tested next?
...
## 4. Which result best proves recovery of operability?
...
## 5. A measurement related to security is high. What is the best interpretation?
...
## 6. Which change practice is safest for cost?
...
## 7. A candidate needs to investigate migration safely. What is the best first approach?
...
## 8. A ownership change works now but must survive reboot. Which evidence is strongest?
...
## 9. Users are denied while an administrator succeeds in governance and review. What should be tested next?
