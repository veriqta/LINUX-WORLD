# Distributed Systems on Linux: Troubleshooting Cases
...
**Domain evidence:** `ss -ti`, `tc netem in a lab`, `chronyc tracking`, `dig`, `curl --trace-time`, `systemd-run`, `coredumpctl`, `tcpdump`
