# Distributed Systems on Linux: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate timeouts safely. What is the best first approach?

A. Restart the service immediately

B. Run `ss -ti`, define the expected evidence and preserve the before state
...
## 2. A retries change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in backoff. What should be tested next?
...
## 4. Which result best proves recovery of idempotency?
...
## 5. A measurement related to quorum is high. What is the best interpretation?
...
## 6. Which change practice is safest for leader election?
...
## 7. A candidate needs to investigate split brain safely. What is the best first approach?

A. Restart the service immediately

B. Run `coredumpctl`, define the expected evidence and preserve the before state
...
## 8. A consistency change works now but must survive reboot. Which evidence is strongest?
...
## 9. Users are denied while an administrator succeeds in clock and backpressure. What should be tested next?
