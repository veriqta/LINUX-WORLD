# Reliability SLO and Capacity Engineering: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate SLI safely. What is the best first approach?

A. Restart the service immediately

B. Run `sar`, define the expected evidence and preserve the before state
...
## 2. A SLO change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in error budget. What should be tested next?
...
## 4. Which result best proves recovery of burn rate?
...
## 5. A measurement related to queueing is high. What is the best interpretation?
...
## 6. Which change practice is safest for utilization?
...
## 7. A candidate needs to investigate saturation safely. What is the best first approach?

A. Restart the service immediately

B. Run `stress-ng`, define the expected evidence and preserve the before state
...
## 8. A headroom change works now but must survive reboot. Which evidence is strongest?
...
## 9. Users are denied while an administrator succeeds in failure domains and load shedding. What should be tested next?
