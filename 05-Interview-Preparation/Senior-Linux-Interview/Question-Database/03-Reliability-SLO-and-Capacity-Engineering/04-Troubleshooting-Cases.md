# Reliability SLO and Capacity Engineering: Troubleshooting Cases
...
**Domain evidence:** `sar`, `pidstat`, `iostat -xz`, `ss -s`, `tc -s qdisc`, `systemd-cgtop`, `stress-ng`, `fio with an authorized test file`
