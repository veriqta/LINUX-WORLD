# Users Groups Sudo and Permissions: Troubleshooting Cases
...
**Domain evidence:** `id USER`, `getent passwd USER`, `getent group GROUP`, `namei -l PATH`, `stat -c "%U %G %a" FILE`, `sudo -l`, `umask`
