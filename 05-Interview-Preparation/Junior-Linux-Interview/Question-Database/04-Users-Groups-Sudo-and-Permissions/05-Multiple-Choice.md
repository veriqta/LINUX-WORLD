# Users Groups Sudo and Permissions: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate UID safely. What is the best first approach?

A. Restart the service immediately

B. Run `id USER`, define the expected evidence and preserve the before state
...
## 2. A GID change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in primary and supplementary groups. What should be tested next?
...
## 4. Which result best proves recovery of ownership?
...
## 5. A measurement related to rwx is high. What is the best interpretation?
...
## 6. Which change practice is safest for octal mode?
...
## 7. A candidate needs to investigate umask safely. What is the best first approach?

A. Restart the service immediately

B. Run `umask`, define the expected evidence and preserve the before state
...
## 8. A sudo and service accounts change works now but must survive reboot. Which evidence is strongest?
