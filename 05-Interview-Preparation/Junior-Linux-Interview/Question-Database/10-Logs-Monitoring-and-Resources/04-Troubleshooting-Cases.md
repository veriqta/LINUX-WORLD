# Logs Monitoring and Resources: Troubleshooting Cases
...
**Domain evidence:** `journalctl --since "15 min ago"`, `free -h`, `uptime`, `vmstat 1 5`, `top`, `dmesg --level=err,warn`, `timedatectl`
