# Logs Monitoring and Resources: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate journal safely. What is the best first approach?

A. Restart the service immediately

B. Run `journalctl --since "15 min ago"`, define the expected evidence and preserve the before state
...
## 2. A syslog change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in log rotation. What should be tested next?
...
## 4. Which result best proves recovery of CPU?
...
## 5. A measurement related to memory is high. What is the best interpretation?
...
## 6. Which change practice is safest for swap?
...
## 7. A candidate needs to investigate load safely. What is the best first approach?

A. Restart the service immediately

B. Run `timedatectl`, define the expected evidence and preserve the before state
...
## 8. A disk latency and time window change works now but must survive reboot. Which evidence is strongest?
