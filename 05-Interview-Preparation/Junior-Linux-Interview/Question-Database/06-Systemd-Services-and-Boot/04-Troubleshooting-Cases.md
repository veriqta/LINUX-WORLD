# Systemd Services and Boot: Troubleshooting Cases
...
**Domain evidence:** `systemctl status UNIT`, `systemctl is-enabled UNIT`, `systemctl cat UNIT`, `systemctl list-dependencies UNIT`, `journalctl -u UNIT -b`, `systemd-analyze blame`
