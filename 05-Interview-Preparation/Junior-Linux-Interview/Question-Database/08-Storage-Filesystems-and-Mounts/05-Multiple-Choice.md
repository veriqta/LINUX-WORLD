# Storage Filesystems and Mounts: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate block device safely. What is the best first approach?

A. Restart the service immediately

B. Run `lsblk -f`, define the expected evidence and preserve the before state
...
## 2. A partition change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in filesystem. What should be tested next?
...
## 4. Which result best proves recovery of mount point?
...
## 5. A measurement related to UUID is high. What is the best interpretation?
...
## 6. Which change practice is safest for inode?
...
## 7. A candidate needs to investigate free space and swap safely. What is the best first approach?

A. Restart the service immediately

B. Run `du -xhd1 PATH`, define the expected evidence and preserve the before state
