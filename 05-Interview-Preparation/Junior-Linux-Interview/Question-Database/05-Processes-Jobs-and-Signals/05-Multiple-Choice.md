# Processes Jobs and Signals: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate PID safely. What is the best first approach?

A. Restart the service immediately

B. Run `ps -ef`, define the expected evidence and preserve the before state
...
## 2. A PPID change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in process state. What should be tested next?
...
## 4. Which result best proves recovery of foreground?
...
## 5. A measurement related to background is high. What is the best interpretation?
...
## 6. Which change practice is safest for job control?
...
## 7. A candidate needs to investigate signals safely. What is the best first approach?
...
## 8. A nice value and open files change works now but must survive reboot. Which evidence is strongest?
