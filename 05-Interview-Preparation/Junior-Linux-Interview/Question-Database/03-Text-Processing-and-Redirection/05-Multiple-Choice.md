# Text Processing and Redirection: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate standard input safely. What is the best first approach?

A. Restart the service immediately

B. Run `grep -n PATTERN FILE`, define the expected evidence and preserve the before state
...
## 2. A output change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in error. What should be tested next?
...
## 4. Which result best proves recovery of pipes?
...
## 5. A measurement related to redirection is high. What is the best interpretation?
...
## 6. Which change practice is safest for grep?
...
## 7. A candidate needs to investigate cut safely. What is the best first approach?

A. Restart the service immediately

B. Run `cut -d: -f1 /etc/passwd`, define the expected evidence and preserve the before state
...
## 8. A sort change works now but must survive reboot. Which evidence is strongest?
...
## 9. Users are denied while an administrator succeeds in uniq. What should be tested next?
...
## 10. Which result best proves recovery of tr?
...
## 11. A measurement related to head is high. What is the best interpretation?
...
## 12. Which change practice is safest for tail and tee?
