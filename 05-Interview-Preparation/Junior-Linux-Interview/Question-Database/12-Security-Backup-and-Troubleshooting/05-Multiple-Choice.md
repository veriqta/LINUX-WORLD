# Security Backup and Troubleshooting: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate least privilege safely. What is the best first approach?

A. Restart the service immediately

B. Run `sudo -l`, define the expected evidence and preserve the before state
...
## 2. A patching change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in firewall. What should be tested next?
...
## 4. Which result best proves recovery of secure SSH?
...
## 5. A measurement related to backup is high. What is the best interpretation?
...
## 6. Which change practice is safest for restore?
...
## 7. A candidate needs to investigate evidence safely. What is the best first approach?

A. Restart the service immediately

B. Run `sha256sum FILE`, define the expected evidence and preserve the before state
...
## 8. A hypothesis and escalation change works now but must survive reboot. Which evidence is strongest?
