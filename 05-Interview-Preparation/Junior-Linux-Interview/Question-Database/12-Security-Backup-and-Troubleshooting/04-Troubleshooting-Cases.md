# Security Backup and Troubleshooting: Troubleshooting Cases
...
**Domain evidence:** `sudo -l`, `getfacl PATH`, `sshd -T`, `firewall-cmd --list-all`, `ufw status verbose`, `tar -tf ARCHIVE`, `sha256sum FILE`
