# Networking DNS and SSH: Troubleshooting Cases
...
**Domain evidence:** `ip -brief address`, `ip route`, `ss -lntup`, `getent hosts NAME`, `resolvectl status`, `ping -c 3 HOST`, `ssh -vv USER@HOST`
