# Networking DNS and SSH: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate interface safely. What is the best first approach?

A. Restart the service immediately

B. Run `ip -brief address`, define the expected evidence and preserve the before state
...
## 2. A address change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in route. What should be tested next?
...
## 4. Which result best proves recovery of gateway?
...
## 5. A measurement related to port is high. What is the best interpretation?
...
## 6. Which change practice is safest for socket?
...
## 7. A candidate needs to investigate DNS resolver safely. What is the best first approach?

A. Restart the service immediately

B. Run `ssh -vv USER@HOST`, define the expected evidence and preserve the before state
...
## 8. A TCP change works now but must survive reboot. Which evidence is strongest?
...
## 9. Users are denied while an administrator succeeds in UDP and SSH host verification. What should be tested next?
