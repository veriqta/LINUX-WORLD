# Packages Software and Repositories: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate package safely. What is the best first approach?

A. Restart the service immediately

B. Run `apt-cache policy PKG`, define the expected evidence and preserve the before state
...
## 2. A repository change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in metadata. What should be tested next?
...
## 4. Which result best proves recovery of dependency?
...
## 5. A measurement related to signature is high. What is the best interpretation?
...
## 6. Which change practice is safest for installed files?
...
## 7. A candidate needs to investigate update and removal safely. What is the best first approach?

A. Restart the service immediately

B. Run `dpkg -L PKG`, define the expected evidence and preserve the before state
