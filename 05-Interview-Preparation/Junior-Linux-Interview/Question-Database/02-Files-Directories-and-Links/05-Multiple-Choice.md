# Files Directories and Links: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate absolute and relative paths safely. What is the best first approach?

A. Restart the service immediately

B. Run `pwd`, define the expected evidence and preserve the before state
...
## 2. A inode change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in file type. What should be tested next?
...
## 4. Which result best proves recovery of hard link?
...
## 5. A measurement related to symbolic link is high. What is the best interpretation?
...
## 6. Which change practice is safest for glob?
...
## 7. A candidate needs to investigate hidden file and safe deletion safely. What is the best first approach?

A. Restart the service immediately

B. Run `du -sh PATH`, define the expected evidence and preserve the before state
