# Logging Observability and Time: Troubleshooting Cases
...
**Domain evidence:** `journalctl --list-boots`, `journalctl -o json`, `logger -p local0.notice`, `logrotate -d FILE`, `timedatectl`, `chronyc tracking`, `ss -ulpn`
