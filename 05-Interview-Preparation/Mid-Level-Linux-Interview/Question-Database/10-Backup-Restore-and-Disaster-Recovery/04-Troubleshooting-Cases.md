# Backup Restore and Disaster Recovery: Troubleshooting Cases
...
**Domain evidence:** `rsync -aHAX --numeric-ids`, `tar --xattrs --acls`, `sha256sum`, `restic check`, `borg check`, `systemctl isolate TARGET`
