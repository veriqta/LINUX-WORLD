# Backup Restore and Disaster Recovery: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate RPO safely. What is the best first approach?

A. Restart the service immediately

B. Run `rsync -aHAX --numeric-ids`, define the expected evidence and preserve the before state
...
## 2. A RTO change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in crash consistency. What should be tested next?
...
## 4. Which result best proves recovery of application consistency?
...
## 6. Which change practice is safest for encryption?
...
## 7. A candidate needs to investigate immutability safely. What is the best first approach?
...
## 8. A restore testing and runbooks change works now but must survive reboot. Which evidence is strongest?
