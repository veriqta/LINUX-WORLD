# Boot Kernel and Systemd Diagnostics: Troubleshooting Cases
...
**Domain evidence:** `journalctl -b -1`, `cat /proc/cmdline`, `systemctl --failed`, `systemctl list-dependencies --reverse UNIT`, `systemd-analyze critical-chain`, `lsinitrd or lsinitramfs`
