# Boot Kernel and Systemd Diagnostics: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate firmware safely. What is the best first approach?

A. Restart the service immediately

B. Run `journalctl -b -1`, define the expected evidence and preserve the before state
...
## 2. A bootloader change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in kernel command line. What should be tested next?
...
## 4. Which result best proves recovery of initramfs?
...
## 5. A measurement related to PID 1 is high. What is the best interpretation?
...
## 6. Which change practice is safest for targets?
...
## 7. A candidate needs to investigate dependencies safely. What is the best first approach?
...
## 8. A ordering and rescue change works now but must survive reboot. Which evidence is strongest?
