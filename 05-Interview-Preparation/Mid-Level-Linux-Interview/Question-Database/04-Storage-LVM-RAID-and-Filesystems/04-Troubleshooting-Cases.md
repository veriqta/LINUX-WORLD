# Storage LVM RAID and Filesystems: Troubleshooting Cases
...
**Domain evidence:** `pvs`, `vgs`, `lvs -a -o +devices`, `mdadm --detail DEVICE`, `findmnt --verify`, `xfs_info MOUNT`, `tune2fs -l DEVICE`
