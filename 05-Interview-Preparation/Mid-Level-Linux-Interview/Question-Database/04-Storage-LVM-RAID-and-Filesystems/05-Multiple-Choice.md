# Storage LVM RAID and Filesystems: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate LVM layers safely. What is the best first approach?

A. Restart the service immediately

B. Run `pvs`, define the expected evidence and preserve the before state
...
## 2. A RAID levels change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in alignment. What should be tested next?
...
## 4. Which result best proves recovery of online growth?
...
## 5. A measurement related to snapshots is high. What is the best interpretation?
...
## 6. Which change practice is safest for discard?
...
## 7. A candidate needs to investigate quotas safely. What is the best first approach?

A. Restart the service immediately

B. Run `tune2fs -l DEVICE`, define the expected evidence and preserve the before state
...
## 8. A fstab and filesystem repair change works now but must survive reboot. Which evidence is strongest?
