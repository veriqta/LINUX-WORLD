# Advanced Identity PAM ACL and Sudo: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate NSS safely. What is the best first approach?

A. Restart the service immediately

B. Run `getent passwd USER`, define the expected evidence and preserve the before state
...
## 2. A PAM change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in UID consistency. What should be tested next?
...
## 4. Which result best proves recovery of supplementary groups?
...
## 5. A measurement related to ACL masks is high. What is the best interpretation?
...
## 6. Which change practice is safest for sudo policy?
...
## 7. A candidate needs to investigate SSH authorization and account lifecycle safely. What is the best first approach?
