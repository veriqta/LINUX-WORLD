# Advanced Identity PAM ACL and Sudo: Troubleshooting Cases
...
**Domain evidence:** `getent passwd USER`, `id USER`, `getfacl PATH`, `setfacl -m u:USER:rw PATH`, `visudo -c`, `pamtester SERVICE USER authenticate`
