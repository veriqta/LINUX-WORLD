# Networking Routing Firewall and DNS: Troubleshooting Cases
...
**Domain evidence:** `ip route get ADDRESS`, `ip rule`, `ip neigh`, `ss -s`, `tracepath HOST`, `tcpdump -ni IFACE FILTER`, `nft list ruleset`, `dig +trace NAME`
