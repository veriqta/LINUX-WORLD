# Containers Namespaces and Cgroups: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate image layers safely. What is the best first approach?

A. Restart the service immediately

B. Run `lsns`, define the expected evidence and preserve the before state
...
## 2. A container process model change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in namespaces. What should be tested next?
...
## 4. Which result best proves recovery of cgroups?
...
## 5. A measurement related to capabilities is high. What is the best interpretation?
...
## 6. Which change practice is safest for rootless operation?
...
## 7. A candidate needs to investigate mounts and logging safely. What is the best first approach?

A. Restart the service immediately

B. Run `crictl ps`, define the expected evidence and preserve the before state
