# Containers Namespaces and Cgroups: Troubleshooting Cases
...
**Domain evidence:** `lsns`, `nsenter`, `systemd-cgls`, `cat /proc/PID/cgroup`, `capsh --print`, `podman inspect CONTAINER`, `crictl ps`
