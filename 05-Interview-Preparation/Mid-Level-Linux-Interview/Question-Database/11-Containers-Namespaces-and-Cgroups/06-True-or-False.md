# Containers Namespaces and Cgroups: True or False

## 1. If a command related to image layers exits successfully, the complete requirement is proven.
