# Security Hardening SELinux and AppArmor: Troubleshooting Cases
...
**Domain evidence:** `getenforce`, `ls -Z PATH`, `ausearch -m AVC -ts recent`, `sealert -a FILE`, `aa-status`, `nft list ruleset`, `rpm -V PACKAGE`, `debsums PACKAGE`
