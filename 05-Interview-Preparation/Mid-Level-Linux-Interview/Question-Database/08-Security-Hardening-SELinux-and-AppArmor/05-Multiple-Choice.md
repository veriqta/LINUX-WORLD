# Security Hardening SELinux and AppArmor: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate MAC versus DAC safely. What is the best first approach?

A. Restart the service immediately

B. Run `getenforce`, define the expected evidence and preserve the before state
...
## 2. A labels change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in domains. What should be tested next?
...
## 4. Which result best proves recovery of booleans?
...
## 5. A measurement related to profiles is high. What is the best interpretation?
...
## 6. Which change practice is safest for audit evidence?
...
## 7. A candidate needs to investigate firewall default deny safely. What is the best first approach?

A. Restart the service immediately

B. Run `rpm -V PACKAGE`, define the expected evidence and preserve the before state
...
## 8. A patching and integrity change works now but must survive reboot. Which evidence is strongest?
