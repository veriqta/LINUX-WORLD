# Incident Troubleshooting and Change: Troubleshooting Cases
...
**Domain evidence:** `date -Is`, `uptime -s`, `last -x`, `journalctl --since TIME`, `systemctl list-jobs`, `ss -s`, `git diff`, `logger INCIDENT_MARKER`
