# Incident Troubleshooting and Change: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate impact safely. What is the best first approach?

A. Restart the service immediately

B. Run `date -Is`, define the expected evidence and preserve the before state
...
## 2. A timeline change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in recent change. What should be tested next?
...
## 4. Which result best proves recovery of evidence preservation?
...
## 5. A measurement related to mitigation is high. What is the best interpretation?
...
## 6. Which change practice is safest for rollback?
...
## 7. A candidate needs to investigate escalation safely. What is the best first approach?

A. Restart the service immediately

B. Run `git diff`, define the expected evidence and preserve the before state
...
## 8. A postmortem and corrective action change works now but must survive reboot. Which evidence is strongest?
