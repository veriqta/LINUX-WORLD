# Systemd Service Engineering: Troubleshooting Cases
...
**Domain evidence:** `systemctl show UNIT`, `systemctl edit UNIT`, `systemd-analyze verify FILE`, `systemd-run --scope`, `systemd-analyze security UNIT`, `journalctl -o json-pretty -u UNIT`
