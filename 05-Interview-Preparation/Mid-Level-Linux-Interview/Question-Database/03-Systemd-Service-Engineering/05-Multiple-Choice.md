# Systemd Service Engineering: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate unit dependency graph safely. What is the best first approach?

A. Restart the service immediately

B. Run `systemctl show UNIT`, define the expected evidence and preserve the before state
...
## 2. A readiness change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in restart policy. What should be tested next?
...
## 4. Which result best proves recovery of resource control?
...
## 5. A measurement related to credentials is high. What is the best interpretation?
...
## 6. Which change practice is safest for sandboxing?
...
## 7. A candidate needs to investigate timers and drop-ins safely. What is the best first approach?
