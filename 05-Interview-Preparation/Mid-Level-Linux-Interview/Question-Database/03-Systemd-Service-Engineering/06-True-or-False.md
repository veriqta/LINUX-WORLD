# Systemd Service Engineering: True or False

## 1. If a command related to unit dependency graph exits successfully, the complete requirement is proven.
