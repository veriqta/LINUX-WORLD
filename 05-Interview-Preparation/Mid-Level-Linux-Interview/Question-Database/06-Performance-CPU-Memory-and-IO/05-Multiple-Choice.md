# Performance CPU Memory and IO: Multiple-Choice Bank

Choose the best answer, then explain why every other option is weaker.

## 1. A candidate needs to investigate load safely. What is the best first approach?

A. Restart the service immediately

B. Run `mpstat -P ALL 1`, define the expected evidence and preserve the before state
...
## 2. A run queue change works now but must survive reboot. Which evidence is strongest?
...
## 3. Users are denied while an administrator succeeds in context switch. What should be tested next?
...
## 4. Which result best proves recovery of CPU steal?
...
## 5. A measurement related to PSI is high. What is the best interpretation?
...
## 6. Which change practice is safest for page cache?
...
## 7. A candidate needs to investigate swap safely. What is the best first approach?

A. Restart the service immediately

B. Run `perf stat COMMAND`, define the expected evidence and preserve the before state
...
## 8. A OOM change works now but must survive reboot. Which evidence is strongest?
...
## 9. Users are denied while an administrator succeeds in disk latency. What should be tested next?
...
## 10. Which result best proves recovery of queue depth and saturation?
