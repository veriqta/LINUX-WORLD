# Performance CPU Memory and IO: Troubleshooting Cases
...
**Domain evidence:** `mpstat -P ALL 1`, `pidstat 1`, `vmstat 1`, `iostat -xz 1`, `cat /proc/pressure/{cpu,memory,io}`, `sar`, `perf stat COMMAND`
