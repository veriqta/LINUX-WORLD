...
This runbook provides a controlled response when name resolution fails or returns incorrect answers.
...
- Explain dns-failure-response in an operational context.
...
```bash
resolvectl status; getent ahosts NAME
```
