...
This runbook provides a controlled response when sustained CPU saturation affects service objectives.
...
- Explain high-cpu-response in an operational context.
