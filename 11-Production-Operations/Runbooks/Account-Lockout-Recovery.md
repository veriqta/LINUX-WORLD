...
This runbook provides a controlled response when an authorized user is locked out.
...
- Explain account-lockout-recovery in an operational context.
...
```bash
getent passwd USER; faillock --user USER
```
