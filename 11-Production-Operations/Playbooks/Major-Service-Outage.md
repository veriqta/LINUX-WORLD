...
This playbook coordinates response to a major service outage across technical and organizational boundaries.
...
- Explain major service outage in an operational context.
...
- **Activate when:** Sustained loss of a critical user journey or availability objective.
- **Containment priorities:** Stop unrelated changes. Protect healthy capacity. Consider rollback, traffic shift, or failover.
- **Recovery proof:** Verify Successful user transactions, dependency health, error rate, latency, capacity headroom, and alert recovery.
