...
This playbook coordinates response to a regional outage across technical and organizational boundaries.
...
- Explain regional outage in an operational context.
...
- **Activate when:** A region or site loses service, control-plane capability, or critical dependencies.
- **Containment priorities:** Declare the recovery strategy. Confirm replication. Shift traffic gradually. Protect destination capacity.
- **Recovery proof:** Verify Traffic distribution, destination capacity, data consistency, dependencies, RTO, RPO, and failback readiness.
