...
This playbook coordinates response to a traffic spike across technical and organizational boundaries.
...
- Explain traffic spike in an operational context.
...
- **Activate when:** Demand exceeds forecast or threatens a service constraint.
- **Containment priorities:** Confirm legitimate traffic. Protect critical paths. Scale within tested limits. Rate-limit or shed optional work.
- **Recovery proof:** Verify Success rate, queues, saturation, latency percentiles, scaling stability, cost guardrails, and backlog drain.
