...
This playbook coordinates response to a authentication outage across technical and organizational boundaries.
...
- Explain authentication outage in an operational context.
...
- **Activate when:** Users or services cannot authenticate or authorization decisions fail broadly.
- **Containment priorities:** Protect existing sessions where safe. Freeze identity changes. Validate time, directory, certificate, and policy dependencies.
- **Recovery proof:** Verify New and existing login paths, service accounts, privileged access, audit events, and lockout rate.
