...
This playbook coordinates response to a third party dependency failure across technical and organizational boundaries.
...
- Explain third party dependency failure in an operational context.
...
- **Activate when:** An external provider causes material errors, latency, or unavailable functionality.
- **Containment priorities:** Activate fallback, cache, queue, circuit breaker, or graceful degradation. Open provider escalation.
- **Recovery proof:** Verify Fallback behavior, queued-work safety, provider recovery, reconciliation, user experience, and communication.
