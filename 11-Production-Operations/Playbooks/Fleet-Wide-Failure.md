...
This playbook coordinates response to a fleet wide failure across technical and organizational boundaries.
...
- Explain fleet wide failure in an operational context.
...
- **Activate when:** A common change or dependency affects many hosts or nodes.
- **Containment priorities:** Halt rollout. Preserve unaffected control paths. Recover a small canary, then use bounded rings.
- **Recovery proof:** Verify Canary stability, ring health, management access, shared dependencies, and recurrence signals.
