...
This playbook coordinates response to a monitoring system failure across technical and organizational boundaries.
...
- Explain monitoring system failure in an operational context.
...
- **Activate when:** Collection, storage, querying, alerting, or notification becomes untrustworthy.
- **Containment priorities:** Declare reduced visibility. Freeze risky changes. Use independent checks. Restore the monitoring path.
- **Recovery proof:** Verify Synthetic tests, ingestion delay, query freshness, notification delivery, gaps, and recovered alert state.
