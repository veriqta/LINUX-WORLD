...
This playbook coordinates response to a ransomware response across technical and organizational boundaries.
...
- Explain ransomware response in an operational context.
...
- **Activate when:** Encryption, destructive behavior, or credible extortion indicators appear.
- **Containment priorities:** Isolate affected segments. Protect backup control planes. Disable compromised identities. Preserve evidence.
- **Recovery proof:** Verify Spread has stopped, identities are controlled, backups are clean, restore is tested, and rebuilt systems are trusted.
