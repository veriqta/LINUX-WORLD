...
This playbook coordinates response to a suspected host compromise across technical and organizational boundaries.
...
- Explain suspected host compromise in an operational context.
...
- **Activate when:** Evidence suggests unauthorized access, execution, persistence, or credential use.
- **Containment priorities:** Isolate through approved controls. Preserve volatile evidence. Do not delete artifacts. Engage security response.
- **Recovery proof:** Verify Containment, credential actions, evidence integrity, rebuilt trusted state, detection coverage, and authorized return.
