...
This playbook coordinates response to a data loss event across technical and organizational boundaries.
...
- Explain data loss event in an operational context.
...
- **Activate when:** Expected data is absent, overwritten, corrupted, or no longer trustworthy.
- **Containment priorities:** Stop destructive writes. Preserve logs and snapshots. Define the affected interval. Involve data and security owners.
- **Recovery proof:** Verify Record counts, checksums, application invariants, restore point, consistency, and stakeholder acceptance.
