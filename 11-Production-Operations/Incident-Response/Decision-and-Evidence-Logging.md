# Decision and Evidence Logging

This guide explains how decision and evidence logging supports the ability to reduce harm through structured command, investigation, mitigation, and communication.
...
- Explain decision and evidence logging in an operational context.
...
Decision and Evidence Logging is not complete when a command succeeds or a document exists. It is complete when the intended service outcome is demonstrated, the risk is bounded, the evidence is preserved, and the next responsible person can understand the resulting state.
